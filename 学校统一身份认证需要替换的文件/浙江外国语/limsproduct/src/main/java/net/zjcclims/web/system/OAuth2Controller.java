...
//    private TokenStore tokenStore;
    ...
    public void loginByUsername(HttpServletRequest request,HttpServletResponse response) throws Exception {
        ...
        response.sendRedirect(request.getContextPath()+"/pages/index1.jsp");
    }

    /************************************************************
     * @Description： 有统一身份认证另一个不需要统一身份认证登录入口
     * @作者： 张德冰
     * @日期： 2019-04-03
     ************************************************************/
    ...
    public ModelAndView loginZjcc(HttpServletRequest request){
        ...
        if(username != null && !"".equals(username)
            ...
            mav.setViewName("redirect:/loginByUsername?username="+username+"&&password="+password);
        }else {
