 ...
 * @author Rob Winch
 */
public class CusCasAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public CusCasAuthenticationFilter() {
    ...
    /**
     * Determines if the {@link CusCasAuthenticationFilter} is configured to handle the proxy receptor requests.
     *
     * @return
     */
     ...
     * {@link CusCasAuthenticationFilter#setProxyAuthenticationFailureHandler(AuthenticationFailureHandler) will be used for proxy requests
     * that fail. The value {@link CusCasAuthenticationFilter#setAuthenticationFailureHandler(AuthenticationFailureHandler)} will be used for
