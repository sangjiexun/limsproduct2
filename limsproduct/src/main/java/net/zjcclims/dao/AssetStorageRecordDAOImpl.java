...
import net.zjcclims.domain.AssetStorageRecord;
 ...
 * 
 */
@Repository("AssetStorageRecordDAO")
@Transactional
public class AssetStorageRecordDAOImpl extends AbstractJpaDao<AssetStorageRecord>
		implements AssetStorageRecordDAO {
	 ...
	 *
	 */
	public AssetStorageRecordDAOImpl() {
		super();
	}
	...
	public AssetReceiveRecord findAssetReceiveRecordByPrimaryKey(Integer id, int startResult, int maxRows) throws DataAccessException {
		try {
			...
			return (AssetReceiveRecord) query.getSingleResult();
	 ...
	 *
	 */
	public boolean canBeMerged(AssetStorageRecord entity) {
		return true;
	}
}
