 ...
 * 
 */
@Repository("AssetStorageDAO")
@Transactional
public class AssetStorageDAOImpl extends AbstractJpaDao<AssetStorage>
		implements AssetStorageDAO {
	 ...
	 *
	 */
	public boolean canBeMerged(AssetStorage entity) {
		return true;
	}
}
