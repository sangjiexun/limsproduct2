 ...
 * 
 */
@WebServiceClient(name = "SendMsgTo", targetNamespace = "http://service.pubinfo.com.cn", wsdlLocation = "http://60.191.116.236:8080/gxtMsgService/services/SendMsgTo?wsdl")
	...
	static {
		...
		try {
			...
			baseUrl = cn.com.pubtoinfo.service.SendMsgTo_Service.class
					.getResource(".");
			url = new URL(baseUrl,
					"http://60.191.116.236:8080/gxtMsgService/services/SendMsgTo?wsdl");
		} catch (MalformedURLException e) {
			logger.warning("Failed to create URL for the wsdl Location: 'http://60.191.116.236:8080/gxtMsgService/services/SendMsgTo?wsdl', retrying as a local file");
