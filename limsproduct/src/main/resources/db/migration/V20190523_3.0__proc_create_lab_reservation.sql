...
Begin
	...
	WHILE i<@weekdaylength DO
		...
		## 调用课表保存存储过程
		call proc_create_timetable_appointment(in_username,'labroomApp',null,concat(in_labroom,','),in_status,in_timetableStyle,
		                               in_termId, null,null,null,null,@currWeekday,in_weeks,in_classes,null,null,null,null,
