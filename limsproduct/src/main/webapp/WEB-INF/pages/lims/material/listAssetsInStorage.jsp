...
<div class="layui-layout layui-layout-admin">
	<div class="layui-main">
		...
		<button data-method="newAssetsInStorage" class="layui-btn layui-btn-xs layui-btn-normal apply_btn">新建物资入库</button>
		...
		<table class="layui-hide add_progress" id="assetsInStorageList" lay-filter="assetsInStorageList"></table>
		<script type="text/html" id="parentbar">
			...
			{{#  } }}
			{{#  if(d.status==1){ }}
			<a class="layui-btn layui-btn-xs" lay-event="detail">入库审核</a>
			{{# }  else if(d.status==2){ }}
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/lims/material/listAssetsInStorage.js" ></script>
</body>
