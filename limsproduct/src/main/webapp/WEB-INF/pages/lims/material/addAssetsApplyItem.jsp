    ...
    <div class="layui-main">
        ...
        <form class="layui-form detail_item" action="" lay-filter="addAssets">
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button class="layui-btn" lay-submit lay-filter="saveAddAssetsDetail">保存</button>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/lims/material/addAssetsApplyItem.js"></script>
</body>
