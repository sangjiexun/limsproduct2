            ...
            <div class="layui-row">
                <div class="layui-col-lg6">
                    ...
                    <div class="layui-input-block">
                        <select name="cabinet" id="cabinet" lay-verify="required" lay-filter="assets">
                            <option value=""></option>
                        </select>
                    </div>
                </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/lims/material/chooseAssetsCabinet.js"></script>
</body>
