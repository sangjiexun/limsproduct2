    ...
    <div class="layui-main">
        ...
        <form class="layui-form detail_item" action="" lay-filter="assetsInStorageDetail">
            ...
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button class="layui-btn" lay-submit lay-filter="saveAssetsInStorageDetail">保存</button>
                    <button type="reset" class="layui-btn layui-btn-primary">重置</button>
                </div>
            </div>
        </form>
        <div id="item">
        <button data-method="addAssetInStorage" class="layui-btn layui-btn-xs layui-btn-normal add_btn">新增物资入库条目</button>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/lims/material/editAssetsInStorageDetail.js"></script>
</body>
