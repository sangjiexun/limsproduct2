            ...
            <div class="layui-row">
                <div class="layui-col-lg6">
                    ...
                    <div class="layui-input-block">
                        <input type="text" id= "amount" name="amount"   placeholder="请填写归还数量" autocomplete="on" class="layui-input"/>
                    </div>
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
                    <button class="layui-btn" lay-submit lay-filter="returnRemainAssets">确定</button>
                </div>
            </div>
        </form>
    </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/lims/material/returnRemainAssets.js"></script>
</body>
