...
<html>
	...
	<div class="right-content">
		...
		<div class="layui-layout layui-layout-admin">
			...
			<div>
				...
				<script type="text/html" id="barDemo">
					<a class="layui-btn layui-btn-xs" lay-event="newReverberation">预约</a>
		...
		<script src="${pageContext.request.contextPath}/js/lims/reservation/lab/labRoomList.js" charset="utf-8"></script>
