...
<head>
    ...
    <script>
        ...
        * 编辑 1
        */
        function newPreCapacityRange(isEdit,id) {
            if(isEdit == 0) {
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['1100px', '500px'],
                    content: '${pageContext.request.contextPath}/lims/preCourse/newPreCapacityRange'
                });
                layer.full(index);
            }else {
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['1100px', '500px'],
                    content: '${pageContext.request.contextPath}/lims/preCourse/editPreCapacityRange?id='+id
                });
                layer.full(index);
            }
        }
        ...
        <div class="TabbedPanelsContentGroup">
            <div class="TabbedPanelsContent">
                <div class="content-box">
                    <div class="title">
                        容量范围
                        <input class="btn btn-new" type="button" value="新建" onclick="newPreCapacityRange(0,-1)"/>
                    </div>
                    ...
                    <table>
                        ...
                        <tbody>
                        <c:forEach items="${preCapacityRanges}" var="current" varStatus="i">
                            <tr>
                                <td>${current.id}</td>
                                <td>${current.capaType}</td>
                                <td>${current.capaRange}人</td>
                                <td>
                                    <a onclick="newPreCapacityRange(1,${current.id})">编辑</a>
                                    <a href="${pageContext.request.contextPath}/lims/preCourse/deletePreCapacityRange?id=${current.id}">删除</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
