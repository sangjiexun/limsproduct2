...
<head>
    ...
    <script src="${pageContext.request.contextPath}/bootstrap/js/plugins/bootstrap-table/locale/bootstrap-table-zh-CN.min.js"
            type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/js/lims/preCourseManagement/preCourseList.js"
            type="text/javascript"></script>
    <style>
...
<div class="navigation">
    <div id="navigation">
        <ul>
            ...
            <li class="end"><a href="javascript:void(0)">我的预排课</a></li>
        </ul>
    </div>
</div>
                        ...
                        <form class="form-inline">
                            ...
                            <div class="form-group">
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="view_status1" name="view_status" onclick="refreshBootstrapTable()" checked="checked" value="ALL" class="custom-control-input"/>
                                    <label class="custom-control-label" for="view_status1">所有</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="view_status2" name="view_status" onclick="refreshBootstrapTable()" value="STAND_TO_RELEASE" class="custom-control-input"/>
                                    <label class="custom-control-label" for="view_status2">待发布</label>
                                </div>
                                <div class="custom-control custom-radio">
                                    <input type="radio" id="view_status3" name="view_status" onclick="refreshBootstrapTable()" value="RELEASED" class="custom-control-input"/>
                                    <label class="custom-control-label" for="view_status3">已发布</label>
                                </div>
                            </div>

                            <input type="hidden" id="isMy" name="isMy" value="${isMy}" />

                            <a href='javascript:;' class='btn btn-xs green' title='新建' onclick="newMyPreCourse()"
