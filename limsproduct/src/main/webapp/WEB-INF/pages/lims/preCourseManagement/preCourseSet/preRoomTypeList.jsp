...
<head>
    ...
    <script>
        ...
        * 编辑 1
        */
        function newPreRoomType(isEdit,id) {
            if(isEdit == 0) {
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['1100px', '500px'],
                    content: '${pageContext.request.contextPath}/lims/preCourse/newPreRoomType'
                });
                layer.full(index);
            }else {
                var index = layer.open({
                    ...
                    shadeClose: true,
                    area: ['1100px', '500px'],
                    content: '${pageContext.request.contextPath}/lims/preCourse/editPreRoomType?id='+id
                });
                layer.full(index);
            }
        }
        ...
        <div class="TabbedPanelsContentGroup">
            <div class="TabbedPanelsContent">
                <div class="content-box">
                    <div class="title">
                        房间布局类型
                        <input class="btn btn-new" type="button" value="新建" onclick="newPreRoomType(0,-1)"/>
                    </div>
                    ...
                    <table>
                        ...
                        <tbody>
                        <c:forEach items="${preRoomTypes}" var="current" varStatus="i">
                            <tr>
                                <td>${current.id}</td>
                                <td>${current.roomType}</td>
                                <td>
                                    <a onclick="newPreRoomType(1,${current.id})">编辑</a>
                                    <a href="${pageContext.request.contextPath}/lims/preCourse/deletePreRoomType?id=${current.id}">删除</a>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
