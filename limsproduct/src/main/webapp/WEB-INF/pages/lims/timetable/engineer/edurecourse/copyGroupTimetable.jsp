...
<head>
    ...
    <!-- 页面业务的js引用 -->
    <script src="${pageContext.request.contextPath}/js/lims/timetable/engineer/edurecourse/copyGroupTimetable.js"
            type="text/javascript"></script>
    <style type="text/css">
        label {
            width: 10em;
                    ...
                    <div class="fixed-table-container">
                        <div class="fixed-table-body">
                            <table class="table table-hover">
                                <thead>
                                <tr>
                                    <%--<th><div class="th-inner ">相关计划</div></th>--%>
                                ...
                                <c:forEach items="${timetableAppointments}" var="timetableAppointment" varStatus="i">
                                    ...
                                    <tr style="overflow: hidden">
                                            <%--<td>
                                                <select id="courseDetailNo${timetableAppointment.id}" name="courseDetailNo${timetableAppointment.id}" required>
                                                    <c:forEach items="${schoolCourse.schoolCourseDetails}" var="curr">
                                                        <option value="${curr.courseDetailNo}">
                                                            <div>${curr.user.cname}(教师)_</div>星期${curr.weekday}[${curr.startClass}-${curr.endClass}]节[${curr.startWeek}-${curr.endWeek}]周
                                                        </option>
                                                    </c:forEach>
                                                </select>
                                            </td>--%>
                                        ...
                                        <input type="hidden" name="courseDetailNo${timetableAppointment.id}" id="courseDetailNo${timetableAppointment.id}" value="${courseDetailValue}" />
