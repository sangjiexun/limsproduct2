...
<meta name="decorator" content="iframe"/>
	...
	<script src="${pageContext.request.contextPath}/bootstrap/js/plugins/bootstrap-table/locale/bootstrap-table-zh-CN.min.js"
			type="text/javascript"></script>
	<script src="${pageContext.request.contextPath}/js/lims/timetable/course/auditTimetableAll.js"
			type="text/javascript"></script>
		...
		<c:forEach items="${auditConfigs}" var="auditConfig" varStatus="i">
			<div title="${auditConfig[0]}">
				<iframe scrolling="yes" frameborder="0" id="myResponseList${i.count}"
						src="${pageContext.request.contextPath}/lims/timetable/engineer/educourse/auditTimetableSingle?courseNo=${auditConfig[3]}&state=${auditConfig[1]}&authName=${auditConfig[2]}&curStage=${auditConfig[4]}&curAuthName=${auditConfig[5]}&type=${type}"
