...
<head>
    ...
    <meta name="selfBatch" content="${selfBatch}"/>
    <meta name="selfNoBatch" content="${selfNoBatch}"/>
    ...
    <script src="${pageContext.request.contextPath}/bootstrap/js/plugins/bootstrap-table/locale/bootstrap-table-zh-CN.min.js"
            type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/js/lims/timetable/engineer/selfcourse/selfCourseList.js"
            type="text/javascript"></script>
    <style>
    ...
    <div id="TabbedPanels1" class="TabbedPanels">
        <ul class="TabbedPanelsTabGroup" style="margin-bottom:10px;">
            ...
            <li class="TabbedPanelsTab selected" id="s2">
                <a class="iStyle_Feelings_Tree_Leaf "
                   href="${pageContext.request.contextPath}/lims/timetable/engineer/selfcourse/selfCourseList?type=PLAN"><spring:message code="all.timetable.self"/></a>
            </li>
                        ...
                        <form class="form-inline">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-radio" id="div_status6" <c:if test="${not empty cookie.itype&& cookie.itype.value == 'MANAGE'}"> style="display: none;" </c:if>>
                                    <input type="radio" id="view_status6" name="view_status" onclick="getTimetableStatus()" value="REFUSE" class="custom-control-input"/>
