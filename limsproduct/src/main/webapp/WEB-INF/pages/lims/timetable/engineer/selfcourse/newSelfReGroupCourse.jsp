...
<head>
    ...
    <c:choose>
        <c:when test="${sessionScope.selected_role eq 'ROLE_STUDENT'}">
            <script src="${pageContext.request.contextPath}/js/lims/timetable/engineer/selfcourse/newSelfReGroupCourseByStudent.js"
                    type="text/javascript"></script>
        </c:when>
        <c:otherwise>
            <script src="${pageContext.request.contextPath}/js/lims/timetable/engineer/selfcourse/newSelfReGroupCourse.js"
                    type="text/javascript"></script>
        </c:otherwise>
    </c:choose>
