...
<head>
    ...
    <!-- 页面业务的js引用 -->
    <script src="${pageContext.request.contextPath}/js/lims/timetable/course/adjustEduReTimetableCourse.js"
            type="text/javascript"></script>
...
<div style="height:70%;width:90%;margin:0 auto;">
    <form id="form_lab" action="" method="post">
        ...
        <input type="hidden" id="adjustStatus" name="adjustStatus" value="${adjustStatus}">
        ...
        <input type="hidden" id="courseDetailNo" name="courseDetailNo" value="${courseDetailNo}">
        <input type="hidden" id="adjustWeek" name="adjustWeek" value="${adjustWeek}">
        ...
        <div style="width:95%;">
            <h3><b>
                ...
                <c:if test="${!empty timetableAppointmentSameNumber}">编辑排课选择${timetableAppointmentSameNumber.id}</c:if>
            </b></h3>
