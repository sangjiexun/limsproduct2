...
<head>
    ...
    <!-- 页面业务的js引用 -->
    <script src="${pageContext.request.contextPath}/js/lims/timetable/engineer/educourse/updateEduAdjustCourse.js"
            type="text/javascript"></script>
    <style type="text/css">
            ...
            <tr style="overflow: hidden">
                ...
                <td width="39%">
                    <select id="weekday" name="weekday" required>
                        <c:if test="${!empty timetableAppointmentSameNumber}">
                                <option value ="${timetableAppointmentSameNumber.timetableAppointment.schoolCourseDetail.courseDetailNo}" selected="selected">
                                            星期${timetableAppointmentSameNumber.timetableAppointment.schoolCourseDetail.getWeekday()}(${timetableAppointmentSameNumber.timetableAppointment.schoolCourseDetail.getStartClass()}-${timetableAppointmentSameNumber.timetableAppointment.schoolCourseDetail.getEndClass()}节;${timetableAppointmentSameNumber.timetableAppointment.schoolCourseDetail.getStartWeek()}-${timetableAppointmentSameNumber.timetableAppointment.schoolCourseDetail.getEndWeek()}周)
                                </option>
                        </c:if>
                    </select>
