...
<head>
    ...
    <script src="${pageContext.request.contextPath}/bootstrap/js/plugins/bootstrap-table/locale/bootstrap-table-zh-CN.min.js"
            type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/js/lims/timetable/self/timetableCourseStudentList.js"
            type="text/javascript"></script>
        ...
        <div class="site-box">
            <div class="site-content">
                <div>
                    ...
                    <input type="hidden" value="${termId}" id="term" name="term"/>
                    <input type="hidden" value="${selfId}" id="selfId" name="selfId"/>
                    <table id="table_student"></table>
                </div>
            </div>
        </div>
    </div>
