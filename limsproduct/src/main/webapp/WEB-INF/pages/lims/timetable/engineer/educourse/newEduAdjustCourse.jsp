...
<head>
    ...
    <!-- 页面业务的js引用 -->
    <script src="${pageContext.request.contextPath}/js/lims/timetable/engineer/educourse/newEduAdjustCourse.js"
            type="text/javascript"></script>
    <style type="text/css">
...
<div style="height:70%;width:90%;margin:0 auto;">
    <form id="form_lab" action="" method="post" >
        ...
        <div style="width:95%;">
            ...
            <input type="button" id="backBtn" name="backBtn" value=" 返回 " onclick="closeCurrentWindow()" class="btn btn-primary btn-lg" style="float:right;margin-right: 10px;">
        </div>
