...
<head>
    ...
    <script>
        // 定义全局变量-排课方式入口配置
        var selfBatch = ${selfBatch};
        var selfNoBatch = ${selfNoBatch};
    </script>
    <!-- bootstrap的引用 -->
    ...
    <script src="${pageContext.request.contextPath}/bootstrap/js/plugins/bootstrap-table/locale/bootstrap-table-zh-CN.min.js"
            type="text/javascript"></script>
    <script src="${pageContext.request.contextPath}/js/lims/timetable/self/selfCourseAdjustList.js"
            type="text/javascript"></script>
        ...
        <ul class="TabbedPanelsTabGroup" style="margin-bottom:10px;">
            ...
            <li class="TabbedPanelsTab" id="s1">
                <a class="iStyle_Feelings_Tree_Leaf "
                   href="${pageContext.request.contextPath}/lims/timetable/course/eduCourseList">教务排课</a>
            </li>
            <%--</sec:authorize>--%>
            <li class="TabbedPanelsTab selected" id="s2">
                <a class="iStyle_Feelings_Tree_Leaf "
                   href="${pageContext.request.contextPath}/lims/timetable/self/selfCourseList?type=PLAN">自主排课</a>
            </li>
                ...
                <div>
                    <div id="toolbar">
                        <form class="form-inline">
                            ...
                            <div class="form-group">
                                &ensp;
                                            <input type="radio" name="view_status" onclick="refreshBootstrapTable()" checked="checked" value="ALL">所有
                                            <input type="radio" name="view_status" onclick="refreshBootstrapTable()" value="TIMETABLED">已排课
                                            <input type="radio" name="view_status" onclick="refreshBootstrapTable()" value="STAND_TO_RELEASE">待发布
                                            <input type="radio" name="view_status" onclick="refreshBootstrapTable()" value="RELEASED">已发布
                                            &ensp;&ensp; &ensp;&ensp;
                                            <c:if test="${empty cookie.type|| cookie.type.value != 'MANAGE'}">
                                            ...
                                            <c:if test="${not empty cookie.type&& cookie.type.value == 'MANAGE'}">
