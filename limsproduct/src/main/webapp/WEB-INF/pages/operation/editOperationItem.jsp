...
<body>
  	<div class="navigation">
		<div id="navigation">
			<ul>
				...
				<li class="end"><a href="javascript:void(0)">新增课题</a></li>
			</ul>
		</div>
	</div>
		...
		<ul class="TabbedPanelsTabGroup" style="margin-bottom:10px;">
			...
			<sec:authorize ifNotGranted="ROLE_STUDENT">
				<li class="TabbedPanelsTab selected" id="s2"><a
					class="iStyle_Feelings_Tree_Leaf"
					href="${pageContext.request.contextPath}/operation/listMyOperationItem?currpage=1&status=7&orderBy=9">新增课题</a>
				</li>
			</sec:authorize>
			<sec:authorize ifNotGranted="ROLE_STUDENT">
  ...
  <div class="content-box" style="border: 1px solid #d0d6dc;">
		<div class="title">
			...
			<form:form name="edit_form" id="edit_form" action="${pageContext.request.contextPath}/operation/saveOperationItem?toMyList=${isMine}&flagId=${flagId}" method="POST" modelAttribute="operationItem">
				...
				<fieldset>
					<label>课题名称：</label>
						<form:input id="lpName" path="lpName" class="easyui-validatebox" />
				</fieldset>
				<fieldset>
					<label>学时数(数字)：</label>
					<form:input path="lpDepartmentHours" id="lpDepartmentHours" required="true" onkeyup="value=value.replace(/[^\d]/g,'') " class="easyui-validatebox" />
				</fieldset>
				<fieldset>
					<label>所属课程：</label>
					<form:select path="schoolCourseInfo.courseNumber" class="chzn-select" id="schoolCourseInfo" required="true" style="width: 200px;">
				...
				<fieldset>
					<label>实验总学时：</label>
						<form:input id="lpDepartmentHoursTotal" path="lpDepartmentHoursTotal" class="easyui-validatebox" />
				</fieldset>
					...
					<tr>
						...
						&lt;%&ndash;<th style="width: 100px;">实验中心：</th>
						<td>
								...
								<form:form id="queryForm" method="post"
									...
									<table>
										<tr>
											...
											<td><input class="cancel-submit" type="button" value="取消"
								  ...
								  <table class="color_tb">
									  <tr>
										  ...
										  <td><form:hidden path="lpmrId" />
											  ...
											  <form:select id="lpmr_id" path="assetCabinetWarehouseAccessRecord.id" class="chzn-select">
												  <form:option value="">请选择</form:option>
