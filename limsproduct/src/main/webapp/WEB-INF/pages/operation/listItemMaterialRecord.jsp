...
<head>
    ...
    <script type="text/javascript">
        ...
        function listMyOperationItemRest(){
            var url = "${pageContext.request.contextPath}/operation/listMyOperationItem?currpage=1&status=${status}&orderBy=${orderBy}";
            //page 后面的0--flag
            window.location.href=url;
        }
        //跳转到仪器设备页面
...
<div id="editMaterialRecord" class="easyui-window" closed="true" modal="true" minimizable="true" title="材料使用记录" style="display:none;width: 600px;height: 500px;padding: 20px">
    <div class="content-box">
