    ...
    <div class="content">
        <div class="discuss_content_box">
            <div class="crumbs_nav">
                ...
                <a href="javascript:void(0);">教材简介</a>
            </div>
            <div class="article_container">
                <div class="right_content_article">
                    <div class="teacher_box">
                        <div class="teacher_box_pic">
                            <div class="teacher_pic">
                                <img src="${pageContext.request.contextPath}${artical.imageUrl}">
                            </div>
                        </div>
                        <div class="teacher_box_introduce">
                            <p class="teacher_name">${artical.name}
                            </p>
                            <c:if test="${artical.text!=null&&artical.text!='' }">
	                       		简介<br>
	                       		${artical.text }
                            </c:if>
                            <c:if test="${artical.content!=null&&artical.content!='' }">
	                       		详细介绍<br>
	                       		${artical.content}
                            </c:if>
