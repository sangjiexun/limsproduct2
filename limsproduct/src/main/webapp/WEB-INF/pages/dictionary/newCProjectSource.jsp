...
<div id="navigation">
	<ul>
		...
		<li class="end"><a href="javascript:void(0)">项目来源管理</a></li>
	</ul>
</div>
</div>
...
<div class="title">
	<div id="title">新建项目来源</div>
</div>   	
    		 		
<form:form action="${pageContext.request.contextPath}/saveCProjectSource" method="POST" modelAttribute="cProjectSource">
<fieldset class="introduce-box">
			<legend>基础信息（带<font color=red>*</font>为必填项）<input type="hidden" value="" id="xsd"></legend>
<table cellpadding="0" cellspacing="0" id="viewTable">
<tbody>
   <tr>
      <td class="label" valign="top">项目来源名称：</td>
