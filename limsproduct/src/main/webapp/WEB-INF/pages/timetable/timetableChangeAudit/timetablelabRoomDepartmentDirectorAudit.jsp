...
function savelabRoomDepartmentDirectorAudit(){
	...
	window.location.href="${pageContext.request.contextPath}/timetableChangeAudit/savelabRoomDepartmentDirectorAudit?id=${id}&tage=${tage}&state=${state }&page=${page}&auditResult="+auditResult+"&remark="+remark;
}
</script>
</body>
<!-------------列表结束----------->
