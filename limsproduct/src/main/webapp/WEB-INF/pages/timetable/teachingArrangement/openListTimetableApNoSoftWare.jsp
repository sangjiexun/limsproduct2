                    ...
                    <div class="content-box">
                            ...
                            <table>
                                ...
                                <c:forEach items="${timetableAppointmentMap}" var="current" varStatus="i">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="${pageContext.request.contextPath}/teachingArrangement/deleteTimeTableAppointmentNosoftware?id=${current.id}&courseCode=${courseCode}&term=${term}&tableAppId=0">删除</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                        ...
                        <div class="timetable_box adjust_timetable">
                            ...
                            <form name="form" method="Post"
                                  action="${pageContext.request.contextPath}/teachingArrangement/saveTimetableApNoSoftWare">
                                </c:if>
                                ...
                                <form name="form" method="Post"
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td>
                                                <select class="chzn-select" multiple="multiple" name="labRooms1"
                                                        id="labRooms1" style="width:200px" required="true">
                                            ...
                                            <td>
                                                <select class="chzn-select" multiple="multiple"
                                                        data-placeholder='请选择实训课题：' name="items" id="items"
                                                        style="width:150px" required="true">
                                                    <option value="0"
                                                            selected> ${courseCodes.schoolCourseInfo.courseName}</option>
                                            ...
                                            <!--调整星期  -->
                                            <td>
                                                <select class="chzn-select" name="weekday" id="weekday"
                                                        style="width:80px">
                                            ...
                                            <td>
                                                <select class="chzn-select" multiple="multiple" name="weeks"
                                                        data-placeholder='请选择周次：' id="weeks" style="width:150px"
                                                        required="true">
                                            ...
                                            <td>
                                                <select class="chzn-select" multiple="multiple" name="teachers"
                                                        id="teachers" data-placeholder='请选择授课教师：' style="width:200px"
                                                        required="true">
                                                    <c:forEach items="${timetableTearcherMap}" var="current"
                                                               varStatus="i">
                                        ...
                                        <tr>
                                            <td colspan=6>
                                                ...
                                                <input type="hidden" name="courseDetailNo"
                                                       value="${courseCodes.courseCode}">
                                                <input type="hidden" name="term" value="${schoolTerm.id}">
                                                <input type="hidden" value="${tableAppId}" name="id">
                                                <a style="float:right;width:44px;height:26px;"
                                                   onclick="checkForm('${courseCode}')">保存</a>
                                            <td colspan=3>
