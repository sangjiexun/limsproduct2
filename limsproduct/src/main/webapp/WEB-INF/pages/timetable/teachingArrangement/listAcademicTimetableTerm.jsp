...
<div id="TabbedPanels1" class="TabbedPanels">
	...
	<sec:authorize ifNotGranted="ROLE_TEACHER,ROLE_LABMANAGER">
		<li class="TabbedPanelsTab selected" id="s1"><a class="iStyle_Feelings_Tree_Leaf " href="${pageContext.request.contextPath}/teachingArrangement/listAcademicTimetableTerm?currpage=1&id=-1">教务排课推送</a></li>
	</sec:authorize>
		<li class="TabbedPanelsTab" id="s2"><a class="iStyle_Feelings_Tree_Leaf " href="${pageContext.request.contextPath}/teachingArrangement/listGeneralTimetableQuery">课表查询</a>
	        </li>
		<li class="TabbedPanelsTab" id="s3"><a class="iStyle_Feelings_Tree_Leaf " href="${pageContext.request.contextPath}/teachingArrangement/listPracticalTimetableTrain?currpage=1&id=-1&flag=0">课内实践申请</a></li>
	<sec:authorize ifNotGranted="ROLE_TEACHER,ROLE_LABMANAGER" >
		<li class="TabbedPanelsTab" id="s4"><a class="iStyle_Feelings_Tree_Leaf " href="${pageContext.request.contextPath}/teachingArrangement/listPracticalTimetableTrain?currpage=1&id=-1&flag=1">实训专用周安排</a></li>
	</sec:authorize>
	<sec:authorize ifNotGranted="ROLE_STUDENT" >
		<li class="TabbedPanelsTab" id="s5"><a class="iStyle_Feelings_Tree_Leaf " href="${pageContext.request.contextPath}/teachingArrangement/timetablevertifyRelease?currpage=1&id=-1&status=-1">实践性教学排课审核及发布</a></li>
	</sec:authorize>
	</ul>
</div>
				...
				<div class="TabbedPanelsContent">
					<div class="tool-box" style="overflow:initial">
						<form:form name="form" method="Post"
								   action="${pageContext.request.contextPath}/teachingArrangement/listAcademicTimetableTerm?currpage=1&id=-1"
							...
							<ul>
								...
								<li>
									<a href="${pageContext.request.contextPath}/teachingArrangement/listAcademicTimetableTerm?currpage=1&id=-1"><input
					...
					<div class="content-box">
						...
						<a href="javascript:void(0)"
						   onclick="targetUrl('${pageContext.request.contextPath}/teachingArrangement/listAcademicTimetableTerm?currpage=${pageModel.firstPage}&term=${termId }&id=<%=request.getParameter("id") %>')"
						   target="_self">首页</a>
						<a href="javascript:void(0)"
						   onclick="targetUrl('${pageContext.request.contextPath}/teachingArrangement/listAcademicTimetableTerm?currpage=${pageModel.previousPage}&term=${termId }&id=<%=request.getParameter("id") %>')"
						   target="_self">上一页</a>
						第
						<select onchange="targetUrl(this.options[this.selectedIndex].value)">
							...
							<c:forEach begin="${pageModel.firstPage}" end="${pageModel.lastPage}" step="1" varStatus="j"
								...
								<c:if test="${j.index!=page}">
									<option value="${pageContext.request.contextPath}/teachingArrangement/listAcademicTimetableTerm?currpage=${j.index}&term=${termId }&id=<%=request.getParameter("id") %>">${j.index}</option>
								</c:if>
							</c:forEach>
						</select>页
						<a href="javascript:void(0)"
						   onclick="targetUrl('${pageContext.request.contextPath}/teachingArrangement/listAcademicTimetableTerm?currpage=${pageModel.nextPage}&term=${termId }&id=<%=request.getParameter("id") %>')"
						   target="_self">下一页</a>
						<a href="javascript:void(0)"
						   onclick="targetUrl('${pageContext.request.contextPath}/teachingArrangement/listAcademicTimetableTerm?currpage=${pageModel.lastPage}&term=${termId }&id=<%=request.getParameter("id") %>')"
						   target="_self">末页</a>
