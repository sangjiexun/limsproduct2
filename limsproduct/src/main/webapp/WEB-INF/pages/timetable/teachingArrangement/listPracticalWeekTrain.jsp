...
<div class="iStyle_RightInner">
	<div class="navigation">
		<div id="navigation">
			<ul>
				...
				<li class="end"><a href="javascript:void(0)">实训专用周安排</a></li>
			</ul>
		</div>
	</div>
	<div id="TabbedPanels1" class="TabbedPanels">
		<ul class="TabbedPanelsTabGroup" style="margin-bottom:10px;">
			...
			<sec:authorize ifNotGranted="ROLE_TEACHER,ROLE_LABMANAGER">
				<li class="TabbedPanelsTab selected" id="s4"><a class="iStyle_Feelings_Tree_Leaf "
				...
				<div class="TabbedPanelsContent">
					<div class="tool-box" style="overflow:initial">
						<form:form name="form" method="Post"
								   action="${pageContext.request.contextPath}/teachingArrangement/listPracticalTimetableTrain?currpage=1&id=-1&flag=1"
							...
							<ul>
								...
								<li>
									<a href="${pageContext.request.contextPath}/teachingArrangement/listPracticalTimetableTrain?currpage=1&id=-1&flag=1"><input
