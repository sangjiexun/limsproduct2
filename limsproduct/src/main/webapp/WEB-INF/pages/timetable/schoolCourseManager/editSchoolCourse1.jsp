...
<body>
  ...
  <div class="content-box">
					   ...
					   <th>选课组名称</th>
						...
						<td>
							<%--<select class="chzn-select" id="labRoomId" name="labRoomId" style="width:200px" required="true">--%>
						     ...
						     <%--</select>--%>
								<form:input
										path="courseAddressType" name="courseAddressType" style="width:145px" />
						</td>
						</c:if>
						<th>课程负责教师</th>
						<td>
	...
	<script type="text/javascript">
			...
			function back(){
			window.location.href="${pageContext.request.contextPath}/timetable/listCourseDetails1?currpage=1&id=-1&flag="+${flag};
			}
