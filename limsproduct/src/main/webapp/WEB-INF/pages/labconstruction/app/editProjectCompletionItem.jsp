...
<div class="navigation">
	...
	<form:form action="${pageContext.request.contextPath}/labconstruction/saveUpdateProjectCompletionItem?AppId=${item.labConstructApp.id}" method="post" modelAttribute="item" >
