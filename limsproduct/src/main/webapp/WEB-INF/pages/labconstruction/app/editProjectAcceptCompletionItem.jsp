...
<div class="navigation">
	...
	<form:form action="${pageContext.request.contextPath}/labconstruction/saveUpdateProjectAcceptCompletionItem?AppId=${item.projectAcceptanceApplication.id}&flag=${flag}" method="post" modelAttribute="item" >
		...
		<tbody>
			<tr>
		     	...
		     	<td>
		     	<form:hidden path="id"/>
		     	<form:input path="experimentName"/>
		     	</td>
			</tr>
			<tr>
		     	<td>是否原有项目：</td>
		     	<td>
		     	<form:input path="isOriginal"/>
		     	</td>
			</tr>
		</tbody>
		</table>
