...
<div class="navigation">
	...
	<form:form action="${pageContext.request.contextPath}/labconstruction/saveUpdateProjectStartCompletionItem?AppId=${item.projectStartedReport.id}&flag=${flag}" method="post" modelAttribute="item" >
