...
<div class="navigation">
	...
	<form:form action="${pageContext.request.contextPath}/labconstruction/saveUpdateProjectDevice?AppId=${device.labConstructApp.id}" method="post" modelAttribute="device" >
