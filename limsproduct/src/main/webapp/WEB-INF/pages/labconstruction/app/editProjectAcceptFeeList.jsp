...
<div class="navigation">
	...
	<form:form action="${pageContext.request.contextPath}/labconstruction/saveUpdateProjectAcceptFeeList?AppId=${fee.projectAcceptanceApplication.id}&flag=${flag}" method="post" modelAttribute="fee" >
		...
		<tbody>
			...
			<tr>
		        ...
		        <form:input path="budgetaryItem"/>
					...
					<tr>
					<td colspan="5">
					<input type="submit btn-big" value="确定" />
