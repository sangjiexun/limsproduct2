...
<div class="navigation">
	...
	<form:form action="${pageContext.request.contextPath}/labconstruction/saveUpdateProjectStartDevice?AppId=${device.projectStartedReport.id}&flag=${flag}" method="post" modelAttribute="device" >
