					...
					<div class="content-box">
						...
						<div class="new-classroom">
                            <table  class="tb"  id="my_show"> 
				                <thead>
				                    <tr>
				                    <th><label style="margin-left: 16px">测试标题：</label></th>
			...
			<c:forEach items="${tAssignmentGradings}" var="current"  varStatus="i">
		   		<tr>
					...
					<td>
			       	...
			       	<td>
			       		<a href="${pageContext.request.contextPath}/teaching/exam/findExamDetail?tCourseSiteId=${tCourseSite.id }&assignGradingId=${current.accessmentgradingId}&moduleType=${moduleType}&selectId=${selectId}">答题详情</a>
			       	</td>
				</tr>
			</c:forEach>
		</tbody>
			...
			<c:forEach items="${tAssignmentGradings}" var="current"  varStatus="i">
		   		<tr>
					...
					<td>
			       	...
			       	<td>
			       		<a href="${pageContext.request.contextPath}/teaching/exam/findExamDetailForStudent?tCourseSiteId=${tCourseSite.id }&examId=${current.TAssignment.id}&moduleType=${moduleType}&selectId=${selectId}">查看</a>
			       	</td>
				</tr>
			</c:forEach>
		</tbody>
