...
<div class="iStyle_Marksfeild">
	<mytag:JspSecurity realm="check" menu="tAssignment">
     	<div class="iStyle_Mark iStyle_ActiveMark" src="${pageContext.request.contextPath}/teaching/assignment/assignmentList?flag=1"><span>可发布测验</span></div>
     	<div class="iStyle_Mark" src="${pageContext.request.contextPath}/teaching/assignment/assignmentList?flag=0"><span>已发布测验</span></div>
	</mytag:JspSecurity>
</div>
</div>

<div class="iStyle_Iframe" id="ssd" >
     <iframe  scrolling="yes" src="${pageContext.request.contextPath}/teaching/assignment/assignmentList?flag=0" id="mainframe">
     </iframe>
