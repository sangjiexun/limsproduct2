		  	...
		  	<div class="TabbedPanelsContentGroup">
				<div class="TabbedPanelsContent">
					<div class="content-box">
						...
						<form:form id="myForm" action="${pageContext.request.contextPath}/teaching/assignment/saveTAssignmentGrade?moduleType=${moduleType }&selectId=${selectId}" method="POST" modelAttribute="tAssignmentGrade" onsubmit="return checkForm()" enctype="multipart/form-data">
