		...
		<div id="TabbedPanels1" class="TabbedPanels">
		  	<div class="TabbedPanelsContentGroup layout_question_left">
				...
				<div class="TabbedPanelsContent">
					<div class="content-box" >
						<div class="title">
							<div id="title">开始答题</div>${deviceId }
						</div>
						<form:form name="myForm" action="${pageContext.request.contextPath}/teaching/test/saveTAssignmentItemMapping?moduleType=${moduleType}&selectId=${selectId}&deviceId=${deviceId}" method="POST" onsubmit="return checkForm()">
