				                	...
				                	<c:forEach items="${tAssignmentQuestionpools }" var="questionPool" varStatus="i">
				                		<c:if test="${questionPool.type != 1&& questionPool.TAssignmentQuestionpool == null }">
				                			<tr>
					                			...
					                			<td>
					                				<a href="${pageContext.request.contextPath }/teaching/question/findItemListByQuestionId?currpage=1&sectionId=${sectionId }&questionId=${questionPool.questionpoolId}">选择</a>
												</td>
					                		</tr>
					                		<c:forEach items="${questionPool.TAssignmentQuestionpools }" var="questionPool1" varStatus="j">
						                		<tr class="children1">
						                			...
						                			<td>
						                				<a href="${pageContext.request.contextPath }/teaching/question/findItemListByQuestionId?currpage=1&sectionId=${sectionId }&questionId=${questionPool1.questionpoolId}">选择</a>
													</td>
						                		</tr>
						                		<c:forEach items="${questionPool1.TAssignmentQuestionpools }" var="questionPool2" varStatus="k">
							                		<tr class="children2">
							                			...
							                			<td>
							                				<a href="${pageContext.request.contextPath }/teaching/question/findItemListByQuestionId?currpage=1&sectionId=${sectionId }&questionId=${questionPool2.questionpoolId}">选择</a>
							                			</td>
							                		</tr>
							                	</c:forEach>
						                	</c:forEach>
