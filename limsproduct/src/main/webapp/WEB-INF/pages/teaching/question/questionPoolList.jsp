...
<body>
				                	...
				                	<c:forEach items="${tAssignmentQuestionpools }" var="questionPool" varStatus="i">
				                		<c:if test="${questionPool.type != 1&& questionPool.TAssignmentQuestionpool == null }">
				                			<tr>
					                			<td>${i.count }</td>
					                			<td>
													<a href="${pageContext.request.contextPath }/teaching/question/findTAssignmentItemsByQuestionId?currpage=1&id=${questionPool.questionpoolId}">${questionPool.title }</a>
												</td>
					                			...
					                			<td>
													<a href="javascript:void(0)" onclick="openwindow(${questionPool.questionpoolId})">修改</a>
					                				<a href="${pageContext.request.contextPath }/teaching/question/deleteQuestionPoolById?questionId=${questionPool.questionpoolId}" onclick="return confirm('删除该题库会同时删除下面的试题,确认删除该题库？')">删除</a>
												</td>
					                		</tr>
					                		<c:forEach items="${questionPool.TAssignmentQuestionpools }" var="questionPool1" varStatus="j">
						                		<tr class="children1">
						                			<td>${j.count }</td>
						                			<td>
														<a href="${pageContext.request.contextPath }/teaching/question/findTAssignmentItemsByQuestionId?currpage=1&id=${questionPool1.questionpoolId}">${questionPool1.title }</a>
													</td>
						                			...
						                			<td>
														<a href="javascript:void(0)" onclick="openwindow(${questionPool1.questionpoolId})">修改</a>
					                					<a href="${pageContext.request.contextPath }/teaching/question/deleteQuestionPoolById?questionId=${questionPool1.questionpoolId}" onclick="return confirm('删除该题库会同时删除下面的试题,确认删除该题库？')">删除</a>
													</td>
						                		</tr>
						                		<c:forEach items="${questionPool1.TAssignmentQuestionpools }" var="questionPool2" varStatus="k">
							                		<tr class="children2">
							                			<td>${k.count }</td>
							                			<td>
							                				<a href="${pageContext.request.contextPath }/teaching/question/findTAssignmentItemsByQuestionId?currpage=1&id=${questionPool2.questionpoolId}">${questionPool2.title }</a>
							                			</td>
							                			...
							                			<td>
							                				<a href="javascript:void(0)" onclick="openwindow(${questionPool2.questionpoolId})">修改</a>
					                						<a href="${pageContext.request.contextPath }/teaching/question/deleteQuestionPoolById?questionId=${questionPool2.questionpoolId}" onclick="return confirm('删除该题库会同时删除下面的试题,确认删除该题库？')">删除</a>
							                			</td>
							                		</tr>
							                	</c:forEach>
						                	</c:forEach>
	...
	<div id="openWindow" class="easyui-window" title="题库分类" modal="true" dosize="true" maximizable="true" collapsible="true" minimizable="false" closed="true" iconcls="icon-add" style="width: 1000px; height:300px;">
		<form:form action="${pageContext.request.contextPath }/teaching/question/saveQuestionPool" method="POST" modelAttribute="tAssignmentQuestionpool">
			<div class="right-content">
				<div id="TabbedPanels1" class="TabbedPanels">
					<div class="TabbedPanelsContentGroup">
						<div class="TabbedPanelsContent">
