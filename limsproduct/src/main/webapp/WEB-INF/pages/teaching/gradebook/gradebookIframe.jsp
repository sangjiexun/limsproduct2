...
<div class="iStyle_Marksfeild">
	<mytag:JspSecurity realm="check" menu="gradebook">
     <div class="iStyle_Mark iStyle_ActiveMark" src="${pageContext.request.contextPath}/teaching/gradebook/gradebookList?flag=1"><span>成绩项一览</span></div>
     <div class="iStyle_Mark" src="${pageContext.request.contextPath}/teaching/gradebook/gradebookStudentList?flag=0"><span>学生成绩明细</span></div>
    </mytag:JspSecurity>     
</div>
</div>

<div class="iStyle_Iframe" id="ssd" >
     <iframe  scrolling="yes" src="${pageContext.request.contextPath}/teaching/gradebook/gradebookList?flag=1" id="mainframe">
     </iframe>
