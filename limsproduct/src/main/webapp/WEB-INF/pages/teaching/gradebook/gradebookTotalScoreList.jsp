...
<thead>
    <tr>                   
        <th>姓名</th>
        <th>学号</th>
        <th>作业<br>${fn:substring(100*weightSettings[0].weight,0,fn:indexOf(100*weightSettings[0].weight, ".")) }%</th>
        <th>测验<br>${fn:substring(100*weightSettings[1].weight,0,fn:indexOf(100*weightSettings[1].weight, ".")) }%</th>
        <th>考试<br>${fn:substring(100*weightSettings[2].weight,0,fn:indexOf(100*weightSettings[2].weight, ".")) }%</th>
        <th>总评</th>
    </tr>
</thead>
<tbody>
<!--遍历课程站点成员列表  -->
<c:forEach items="${lists}" var="current"  varStatus="i">
	<tr> 
