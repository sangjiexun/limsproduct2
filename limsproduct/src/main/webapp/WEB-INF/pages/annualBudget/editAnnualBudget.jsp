...
<script type="text/javascript">
	function formValidate() {
		if($("#academyName").val()==""){
			...
			alert("请输入项目名称");
		}else if($("#projectSource").val()==""){
			alert("请输入项目来源");
		} else if($("#constructYear").val()==""){
			alert("请输入建设年度");
		}else if($("#projectFunds").val()==""){
			alert("请输入项目经费");
		}else if($("#manager").val()==""){
			alert("请输入项目负责人");
		}else if($("#projectProceed").val()==""){
			alert("请输入项目进程");
		}else if($("#deadLines").val()==""){
            alert("请输入最晚验收时间");
		}else{
            sub('${pageContext.request.contextPath}/annualBudget/saveAnnualBudget');
		}
	}
...
<div class="navigation">
				<div id="navigation">
					<ul>
						<li><a href="javascript:void(0)"><spring:message code="left.labconstruction.annualBudget"/></a></li>
						<li class="end"><a href="javascript:void(0)">新建历年项目</a></li>
					</ul>
				</div>
			</div>
...
<tbody>
    <tr>
     	<form:hidden path="id"/>
	   	<td class="label" valign="top"><font color=red>*</font>系部：</td>
	   	<td><form:input path="academyName" id="academyName" /></td>
	   	<td class="label" valign="top"><font color=red>*</font>项目名称：</td>
	   	<td><form:input path="projectName" id="projectName" /></td>
	</tr>
	<tr>
		<td class="label" valign="top"><font color=red>*</font>项目来源：</td>
	   	<td><form:input path="projectSource" id="projectSource" /></td>
	   	<td class="label" valign="top"><font color=red>*</font>建设年度：</td>
	   	<td><form:input path="constructYear" id="constructYear" /></td>
	</tr>
	<tr>
		<td class="label" valign="top"><font color=red>*</font>项目经费（万元）：</td>
	   	<td><form:input path="projectFunds" id="projectFunds" /></td>
	   	<td class="label" valign="top"><font color=red>*</font>项目负责人：</td>
	   	<td><form:input path="manager" id="manager" /></td>
	</tr>
	<tr>
		<td class="label" valign="top"><font color=red>*</font>项目进展：</td>
	   	<td><form:input path="projectProceed" id="projectProceed"/></td>
		<td class="label" valign="top"><font color=red>*</font>项目状态：</td>
	...
	<tr>
	   	<td class="label" valign="top"><font color=red>*</font>最晚验收时间：</td>
	   	<td>
	   		<input id="deadLines" name="deadLines" value="<fmt:formatDate value="${annualBudget.deadLines.time}" pattern="yyyy-MM-dd" />"  onclick="new Calendar().show(this);" path="deadLines"  readonly="readonly"  required="true"/>
   		</td>
	</tr>
</tbody>
</table>
	...
	<tr><td colspan="5"></td></tr>
			<%--<input type="button btn btn-big" value="确定" onclick="formValidate()"/>--%>
   			<%--<input type="button btn btn-return" value="取消" onclick="window.history.go(-1);" />--%>
	<div class="moudle_footer" style="background: white">
		<div class="submit_link" style="margin:5px;">
			<input class="btn btn-big" value="确定"  onclick="formValidate();"/>
