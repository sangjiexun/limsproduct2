...
<head>
    ...
    <script type="text/javascript">
        ...
        function cancelQuery(){
            window.location.href="${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceUsage?page=1";
        }
        function print(){
            $('#my_show').jqprint();
        }
...
<div class="right-content">
    <div id="TabbedPanels1" class="TabbedPanels">
        ...
        --%>
            <li class="TabbedPanelsTab" id="s1"><a href="${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceNew?roomId=${roomId }&page=1">设备列表</a></li>
            ...
            <li class="TabbedPanelsTab selected" id="s3"><a href="${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceUsage?page=1&roomId=${roomId }">设备使用记录</a></li>
        </ul>
        <ul class="sub_tit">
            <li class="st_selected">
                <a href="${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceUsage?page=1">设备预约使用记录</a>
            </li>
            <li>
                <a href="${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceUsageInAppointment?page=1">设备教学使用记录</a>
            </li>
        </ul>
        <div class="TabbedPanelsContentGroup">
            <div class="TabbedPanelsContent">
                <div class="content-box">
                    <div class="tool-box">
                        <form:form name="queryForm" action="${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceUsage?page=1" method="post" modelAttribute="reservation">
                            <table class="tab_fix">
                                <tr>
                                    <th>设备名称：</th>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <th>申请时间：</th>
                                    <td>
                                        <input  class="easyui-datebox"  id="begintime" name="begintime1" value="${begintime}"  type="text"  onclick="new Calendar().show(this);" style="width:100px;" />
                                        <span style="">到</span>
                                        <input class="easyui-datebox"  id="endtime" name="endtime1"  value="${endtime}" type="text"  onclick="new Calendar().show(this);" style="width:100px;" />
                                    </td>
                                    <th>设备管理员：</th>
                                    <td>
...
<%--                        <a class="btn btn-new" onclick="exportLabRoomDeviceUsage()">导出</a>
                    ...
                    <div class="page" >
                        ...
                        <a href="javascript:void(0)" onclick="targetUrl('${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceUsage?page=1')" target="_self">首页</a>
                        <a href="javascript:void(0)" onclick="targetUrl('${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceUsage?page=${pageModel.previousPage}')" target="_self">上一页</a>
                        第<select onchange="javascript:window.location.href = this.options[this.selectedIndex].value;">
                        <option selected="selected" value="${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceUsage?page=${page}">${page}</option>
                        <c:forEach begin="${pageModel.firstPage}" end="${pageModel.lastPage}" step="1" varStatus="j" var="current">
                            <c:if test="${j.index!=pageModel.currPage}">
                                <option value="${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceUsage?page=${j.index}">${j.index}</option>
                            </c:if>
                        </c:forEach></select>页
                        <a href="javascript:void(0)"  onclick="targetUrl('${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceUsage?page=${pageModel.nextPage}')" target="_self">下一页</a>
                        <a href="javascript:void(0)"  onclick="targetUrl('${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceUsage?page=${pageModel.lastPage}')" target="_self">末页</a>
                    </div>
                    <!-- 分页模块 -->
                </div>
            </div>
