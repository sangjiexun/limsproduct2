...
<div class="right-content">
    <div id="TabbedPanels1" class="TabbedPanels">
        ...
        --%>
            ...
            <li class="TabbedPanelsTab selected" id="s2"><a href="${pageContext.request.contextPath}/cmsReport/applyDeviceRepairList?page=1&roomId=${roomId }">保修登记</a></li>
            ...
            <div class="TabbedPanelsContentGroup">
                <div class="TabbedPanelsContent">
                    <div class="content-box">
                        <form:form action="${pageContext.request.contextPath}/cmsReport/saveLabRoomDeviceRepair?labRoomDeviceId=-1" method="POST" modelAttribute="labRoomDeviceRepair">
                            <table class="tab_lab">
                                <tr>
                                    <th>保修设备</th>
                                    <td>
                                    ...
                                    <th>报修时间</th>
                                    <td>
                                        <input name="repairTime1" class="easyui-datebox" value="<fmt:formatDate value='${labRoomDeviceRepair.repairTime.time}' pattern='yyyy-MM-dd'/>" />
                                    </td>
                                    <th>修复时间</th>
                                    <td>
                                        <input name="restoreTime1" class="easyui-datebox" value="<fmt:formatDate value='${labRoomDeviceRepair.restoreTime.time}' pattern='yyyy-MM-dd'/>" />
                                    </td>
                                </tr>
                                <tr>
                                    <th>厂家</th>
  ...
  --%>
                    ...
                    <form:form name="queryForm" action="${pageContext.request.contextPath}/cmsReport/applyDeviceRepairList?page=1" method="post" modelAttribute="reservation">
                    </form:form>
                    <%--   <div class="tool-box">
...
<%--                                <td>
                        ...
                        <div class="page" >
                            ...
                            <a href="javascript:void(0)"    onclick="first('${pageContext.request.contextPath}/cmsReport/applyDeviceRepairList?page=1')" target="_self">首页</a>
                            <a href="javascript:void(0)" onclick="previous('${pageContext.request.contextPath}/cmsReport/applyDeviceRepairList?page=')" target="_self">上一页</a>
                            第<select onchange="javascript:window.location.href = this.options[this.selectedIndex].value;">
                            <option value="${pageContext.request.contextPath}/cmsReport/applyDeviceRepairList?page=${page}">${page}</option>
                            <c:forEach begin="${pageModel.firstPage}" end="${pageModel.lastPage}" step="1" varStatus="j" var="current">
                                <c:if test="${j.index!=page}">
                                    <option value="${pageContext.request.contextPath}/cmsReport/applyDeviceRepairList?page=${j.index}">${j.index}</option>
                                </c:if>
                            </c:forEach></select>页
                            <a href="javascript:void(0)" onclick="next('${pageContext.request.contextPath}/cmsReport/applyDeviceRepairList?page=')" target="_self">下一页</a>
                            <a href="javascript:void(0)" onclick="last('${pageContext.request.contextPath}/cmsReport/applyDeviceRepairList?page=${pageModel.totalPage}')" target="_self">末页</a>
                        </div>
                        <!-- 分页模块 -->
                    </div>
