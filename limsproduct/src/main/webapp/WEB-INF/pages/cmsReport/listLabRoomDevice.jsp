...
<div class="TabbedPanelsContent">
    <div class="content-box">
        <div class="tool-box">
            <form:form name="queryForm" action="${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceNew?page=1&roomId=-1" method="post" modelAttribute="labRoomDevice">
                <table class="tab_fix">
                    <tr>
    ...
    <div class="right-content">
        <ul class="layout_classroom_list">
            <c:forEach items="${roomsList}" var="room" varStatus="i">
                <li>
                    <a href="${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceNew?roomId=${room.id}&page=1" title="查看${room.labRoomName }设备列表">
        ...
        <div class="TabbedPanelsContentGroup">
            <div class="TabbedPanelsContent">
                ...
                <div class="page" >
                    ...
                    <a href="javascript:void(0)"    onclick="first('${pageContext.request.contextPath}/cmsReport/listLabRoomDevice?page=1')" target="_self">首页</a>
                    <a href="javascript:void(0)" onclick="previous('${pageContext.request.contextPath}/cmsReport/listLabRoomDevice?page=')" target="_self">上一页</a>
                    第<select onchange="javascript:window.location.href = this.options[this.selectedIndex].value;">
                    <option value="${pageContext.request.contextPath}/cmsReport/listLabRoomDevice?page=${page}">${page}</option>
                    <c:forEach begin="${pageModelLabroom.firstPage}" end="${pageModelLabroom.lastPage}" step="1" varStatus="j" var="current">
                        <c:if test="${j.index!=page}">
                            <option value="${pageContext.request.contextPath}/cmsReport/listLabRoomDevice?page=${j.index}">${j.index}</option>
                        </c:if>
                    </c:forEach></select>页
                    <a href="javascript:void(0)"     onclick="next('${pageContext.request.contextPath}/cmsReport/listLabRoomDevice?page=')" target="_self">下一页</a>
                    <a href="javascript:void(0)"    onclick="last('${pageContext.request.contextPath}/cmsReport/listLabRoomDevice?page=${pageModelLabroom.totalPage}')" target="_self">末页</a>
                </div>
                <!-- 分页模块 -->
            </div>
        </div>
