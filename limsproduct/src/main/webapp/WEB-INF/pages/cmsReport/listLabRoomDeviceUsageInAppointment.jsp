...
<head>
    ...
    <script type="text/javascript">
        ...
        function cancelQuery(){
            window.location.href="${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceUsageInAppointment?page=1";
        }
...
<div class="right-content">
    <div id="TabbedPanels1" class="TabbedPanels">
      ...
      --%>
            <li class="TabbedPanelsTab " id="s1"><a href="${pageContext.request.contextPath}/cmsReport/listLabRoomDevice?page=1&isOrder=${idOrder}">设备管理</a></li>
            <li class="TabbedPanelsTab " id="s2"><a href="${pageContext.request.contextPath}/cmsReport/applyDeviceRepairList?page=1">保修登记</a></li>
            <li class="TabbedPanelsTab selected" id="s3"><a href="${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceUsage?page=1">设备使用记录</a></li>
        </ul>
        <div>
            <ul class="sub_tit">
                <li>
        ...
        <div class="TabbedPanelsContentGroup">
            <div class="TabbedPanelsContent">
                <div class="content-box">
                    <div class="tool-box">
                        <form:form name="queryForm" action="${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceUsageInAppointment?page=1" method="post" >
                            <table class="tab_fix">
                                <tr>
                                    <th>设备名称：</th>
                                    <td>
...
<%--                        <a class="btn btn-new" onclick="exportLabRoomDeviceUsageInAppointment()">导出</a>
                    ...
                    <div class="page" >
                        ...
                        <a href="javascript:void(0)" onclick="targetUrl('${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceUsageInAppointment?page=1')" target="_self">首页</a>
                        <a href="javascript:void(0)" onclick="targetUrl('${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceUsageInAppointment?page=${pageModel.previousPage}')" target="_self">上一页</a>
                        第<select onchange="javascript:window.location.href = this.options[this.selectedIndex].value;">
                        <option selected="selected" value="${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceUsageInAppointment?page=${page}">${page}</option>
                        <c:forEach begin="${pageModel.firstPage}" end="${pageModel.lastPage}" step="1" varStatus="j" var="current">
                            <c:if test="${j.index!=page}">
                                <option value="${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceUsageInAppointment?page=${j.index}">${j.index}</option>
                            </c:if>
                        </c:forEach></select>页
                        <a href="javascript:void(0)"  onclick="targetUrl('${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceUsageInAppointment?page=${pageModel.nextPage}')" target="_self">下一页</a>
                        <a href="javascript:void(0)"  onclick="targetUrl('${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceUsageInAppointment?page=${pageModel.lastPage}')" target="_self">末页</a>
                    </div>
                    <!-- 分页模块 -->
                </div>
...
<script type="text/javascript">
    ...
    function query(){
        document.queryForm.action = "${pageContext.request.contextPath}/cmsReport/listLabRoomDeviceUsageInAppointment?page=1";
        document.queryForm.submit();
    }
</script>
<!-- 下拉框的js -->
