...
<%--<head>
<title>东华大学<spring:message code="all.trainingRoom.labroom" />管理系统1111</title>
...
<% 
   //前端登录标记
   session.setAttribute("LOGINTYPE","res");  
%>
 <%
...
<div class="head">
<spring:message code="title.school.name" /><spring:message code="all.trainingRoom.labroom" />智能管理系统
</div>
<!-- login form-->
...
<div class="test" style="color:white" align="center"><spring:message code="title.school.name" /><spring:message code="all.trainingRoom.labroom" />智能管理系统新版本已经开始试用。<br>由于此系统尚未与统一身份认证对接，系统的用户名和密码为各位老师自己的工号！</div>
