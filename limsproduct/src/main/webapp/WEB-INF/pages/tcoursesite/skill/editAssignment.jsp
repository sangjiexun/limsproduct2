		  	...
		  	<div class="TabbedPanelsContentGroup">
				<div class="TabbedPanelsContent">
					<div class="content-box">
						...
						<form:form action="${pageContext.request.contextPath}/tcoursesite/assignment/saveAssignmentGrading?tCourseSiteId=${tCourseSite.id}" method="POST" modelAttribute="tAssignment" enctype="multipart/form-data">
