	  ...
	  <div class="TabbedPanelsContentGroup">
								  ...
								  <c:forEach items="${tAssignmentQuestionpools }" var="questionPool" varStatus="i">
	                               <c:if test="${questionPool.type != 1 && questionPool.TAssignmentQuestionpool == null}">
	                                <tr>
	                                    ...
	                                    <td>
	                                    	<c:if test="${flag==1}">
	                                        <a href="${pageContext.request.contextPath }/tcoursesite/question/deleteLabRoomQuestionPoolById?labRoomId=${labRoomId}&questionId=${questionPool.questionpoolId}" onclick="return confirm('删除该题库会同时删除下面的试题,确认删除该题库？')">
	                                        	删除</a>
		...
		<!-- 新增题库 -->
					<div id="newQuestionPool" class="easyui-window" title="导入题库" closed="true" modal="true" minimizable="true" style="width:600px;height: 300px;padding:20px">
						<form:form action="${pageContext.request.contextPath}/tcoursesite/question/saveLabRoomQuestionPool?Id=${labRoomId}&page=1" method="POST" modelAttribute="tAssignmentQuestionpool">
