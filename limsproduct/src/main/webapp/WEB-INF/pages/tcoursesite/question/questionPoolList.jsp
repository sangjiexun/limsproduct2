...
<div class="right-content">	
	...
	<div id="TabbedPanels1" class="TabbedPanels">
	 <ul class="TabbedPanelsTabGroup">
		...
		--%><a href="javascript:void(0);" onclick="findQuestionList(${device.id})">题库</a>
		</li>
		<li class="TabbedPanelsTab" tabindex="0">
		<%--<a href="${pageContext.request.contextPath}/teaching/test/testList?status=-1&deviceId=${device.id}">考试</a>		
		--%><a href="javascript:void(0);" onclick="findTestList(${device.id})">考试</a>
		</li>
	</ul>
