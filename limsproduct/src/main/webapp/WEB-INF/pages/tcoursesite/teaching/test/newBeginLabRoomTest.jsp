		  	...
		  	<div class="TabbedPanelsContentGroup layout_question_left">
				...
				<div class="TabbedPanelsContent">
					<div class="content-box" >
						...
						<form:form name="myForm" action="${pageContext.request.contextPath}/teaching/test/saveLabRoomTAssignmentItemMapping?moduleType=${moduleType}&selectId=${selectId}&labRoomId=${labRoomId}" method="POST" onsubmit="return checkForm()">
