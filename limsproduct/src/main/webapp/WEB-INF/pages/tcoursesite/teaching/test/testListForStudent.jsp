...
<body>
	...
	<li class="TabbedPanelsTab" tabindex="0">
		...
		<li class="TabbedPanelsTab" tabindex="0"><a href="#" onclick="viewDeviceReservationRest(${device.id},1)";>使用情况</a></li>
		<li class="TabbedPanelsTab" tabindex="0">
	  ...
	  <div class="TabbedPanelsContentGroup">
		<div class="TabbedPanelsContent">
			...
			<div class="content-box">
				...
				--%><a class="btn btn-new"  href="${pageContext.request.contextPath}/device/listLabRoomDeviceNew?roomId=${labRoomId }&page=${page}" >返回</a>
				</div>											     
				<table  id="my_show">
				<thead>
				    <tr>                   
				...
				<tr>
				    ...
				    <td><a href="${pageContext.request.contextPath}/teaching/test/beginTest?testId=${current.id}&deviceId=${device.id}&labRoomId=${labRoomId}&deviceNumber=${deviceNumber}&deviceName=${deviceName}&username=${username}" >开始考试</a></td>
					</c:if>
					<c:if test="${current.submitTimeForStudent>0&&isCreate==0}">
