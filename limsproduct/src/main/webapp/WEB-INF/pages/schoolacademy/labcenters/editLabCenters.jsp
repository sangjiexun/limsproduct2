...
<html>
<head>
<title>Edit <fmt:message key="schoolacademy.title"/> <fmt:message key="labcenter.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveSchoolAcademyLabCenters" method="POST" modelAttribute="labcenter">
			...
			<script type="text/javascript">Spring.addDecoration(new Spring.ValidateAllDecoration({elementId:'save', event:'onclick'}));</script>
				<input type="hidden" name="schoolacademy_academyNumber" value="${schoolacademy_academyNumber}" >
