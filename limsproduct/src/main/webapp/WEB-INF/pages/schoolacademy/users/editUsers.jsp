...
<html>
<head>
<title>Edit <fmt:message key="schoolacademy.title"/> <fmt:message key="user.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveSchoolAcademyUsers" method="POST" modelAttribute="user">
