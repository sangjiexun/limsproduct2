...
<html>
<head>
<title>Edit <fmt:message key="schoolacademy.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveSchoolAcademy" method="POST" modelAttribute="schoolacademy">
