...
<div class="title">
	<div id="title">领出设备申请单</div>
</div>  
	  <form:form action="${pageContext.request.contextPath}/device/saveDeviceKeepApply" method="post" modelAttribute="labRoomDeviceLend">
		<table>
			<tr>
			...
			<tr>
				...
				<th>领用设备</th><td>${labRoomDevice.schoolDevice.deviceName}<form:hidden path="labRoomDevice.id" value="${labRoomDevice.id }"/></td>
			</tr>
