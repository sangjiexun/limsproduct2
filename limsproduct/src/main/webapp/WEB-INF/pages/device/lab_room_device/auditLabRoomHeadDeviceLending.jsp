...
<table cellpadding="0" cellspacing="0" id="viewTable">
	<tr>
			...
			<tr>
				...
				<th>借用设备</th><td>${lrdl.labRoomDevice.schoolDevice.deviceName}</td>
			</tr>
</table>
	</div>
	...
	<!-- 标题栏  -->
	 ...
	 <!--内容栏  --> 
	  <div class="TabbedPanelsContentGroup">
		<div class="TabbedPanelsContent">
			<div class="content-box">
				<c:if test="${fn:contains(labRoomHeads,user.username)&&lrdl.stage==2}">
					<div class="title">实训部主任意见</div>
				...
				<table id="listTable" width="50%" cellpadding="0" cellspacing="0" class="tablesorter" >
					    <tr><td colspan="6">实训部主任信息 </td></tr>
					    <c:forEach items="${labRoomHeads}" var="admin">
					 	<tr align="center" >
						     <td>姓名：   ${admin.cname}</td> 
						     <td>工号：   ${admin.username}</td> 
						     <td>部门：   ${admin.schoolAcademy.academyName}</td> 
						     <td>联系方式：   ${admin.telephone}</td> 
						</tr>  
					    </c:forEach>
					</table>
				<c:if test="${lrdl.stage==3}">
				<table id="listTable" width="50%" cellpadding="0" cellspacing="0" class="tablesorter">
					<tr><td colspan="6" ><font color="blue">实训部主任审核</font> </td></tr>
					<tr>
						<td>审核意见：通过  </td>
					</tr>
				</table>
...
<script type="text/javascript">
    ...
    function saveAudit(){
        ...
        $.ajax({
            url:'${pageContext.request.contextPath}/device/saveLabRoomHeadDeviceLending?array_ok='
