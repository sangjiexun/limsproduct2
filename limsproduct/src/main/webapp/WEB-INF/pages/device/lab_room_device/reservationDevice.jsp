...
//		    }
			...
			if(event_object.start_date.Format("yyyy-MM-dd hh:mm")<new Date(year,month,day,hour,minute,second).Format("yyyy-MM-dd hh:mm")){
			   ...
			   scheduler.deleteEvent(event_id);
				...
				$.post('${pageContext.request.contextPath}/device/saveDeviceReservation',{equinemtid:equinemtid,startDate:startdate,endDate:enddate,description:description,phone:phone,teacher:teacher,property:property,research:research},function(data){
			        if(data == 'success') {
