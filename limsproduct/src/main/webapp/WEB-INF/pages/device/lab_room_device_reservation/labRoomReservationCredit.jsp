...
function submitForm()
{
  ...
  $("input[name='items']:checked").each(function(){
	...
	if(flag)
	{
	  ...
	  document.itemsForm.action="${pageContext.request.contextPath}/device/saveLabRoomDeviceReservationCredit?reservationId="+${reservation.id}+"&itemIds="+ids+"&remark="+remark;
...
<a class="btn btn-new" href="${pageContext.request.contextPath}/LabRoomDeviceReservation/labRoomDeviceReservationList?currpage=1&tage=1&isaudit=${isAudit}">返回</a>
</div>
</div>
<div class="right-content">	
	...
	<!-- 标题栏  --><%--
	  <ul class="TabbedPanelsTabGroup">
			...
			<a href="${pageContext.request.contextPath}/device/labManagerReservationAudit?id=${reservation.id}">实训室管理员信誉登记</a>
			</li>		
	  </ul>	  
	  --%><!--内容栏  --> 
	  <div class="TabbedPanelsContentGroup">
		<div class="TabbedPanelsContent">
			...
			<c:if test="${empty reservation.labRoomDeviceReservationCredits}">
					<div class="title"><spring:message code="all.trainingRoom.labroom"/>管理员
						...
						<c:if test="${not empty reservation.labRoomDeviceReservationCredits}">
							<form name="itemsForm" method="post">
							<table>								
								<tr>							
									<table class="tb" id="my_show">
