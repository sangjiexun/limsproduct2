            ...
            $.ajax({
                ...
                success:function(data){//AJAX查询成功
                    if(data=="success"){
                        ...
                        var url = "${pageContext.request.contextPath}/device/apidoDeviceReservation/" + labRoom_id + "/"+ schoolDevice_deviceNumber + "/" + schoolDevice_deviceName + "/" + username +"/${page}/" + id+"/"+1+"/"+schoolDevice_allowAppointment;
                        //alert(url);
...
<div id="TabbedPanels1" class="TabbedPanels">
    <ul class="TabbedPanelsTabGroup" style="margin-bottom:10px;">
        <li class="TabbedPanelsTab selected" id="s1"><a href="${pageContext.request.contextPath}/device/apilistLabRoomDevice?page=1&isReservation=1&isOrder=1"><spring:message code="left.instrument.appointment" /></a></li>
    ...
    <div class="">
        ...
        <div class="page" >
            ...
            <a href="javascript:void(0)"    onclick="first('${pageContext.request.contextPath}/device/listLabRoomDevice?isOrder=${isOrder}&page=1')" target="_self">首页</a>
            <a href="javascript:void(0)" onclick="previous('${pageContext.request.contextPath}/device/listLabRoomDevice?isOrder=${isOrder}&page=')" target="_self">上一页</a>
            ...
            <a href="javascript:void(0)"     onclick="next('${pageContext.request.contextPath}/device/listLabRoomDevice?isOrder=${isOrder}&page=')" target="_self">下一页</a>
            <a href="javascript:void(0)"    onclick="last('${pageContext.request.contextPath}/device/listLabRoomDevice?isOrder=${isOrder}&page=${pageModel.totalPage}')" target="_self">末页</a>
        </div>
        <!-- 分页模块 -->
    </div>
</div>
