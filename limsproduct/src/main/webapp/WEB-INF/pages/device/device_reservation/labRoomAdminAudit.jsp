...
<c:if test="${state == 3 && isAudit == 1}">
   <table>
        <tr>
           ...
           <input type="radio" name="auditResult3"  value="2" />拒绝
            </td>
       </tr>
        <tr>
...
function savelabRoomAdminAudit(){
	...
	window.location.href="${pageContext.request.contextPath}/LabRoomDeviceReservation/savelabRoomAdminAudit?id=${id}&tage=${tage}&state=${state }&currpage=${currpage}&auditResult="+auditResult+"&remark="+remark;
}
</script>
</body>
<!-------------列表结束----------->
