            ...
            <div class="TabbedPanelsContent">
                ...
                <div class="content-box">
                    ...
                    <table>
                        ...
                        <tr>
                            <th>备注</th>
                            <td colspan="4"><input type="text" id="remark" name="remark"/></td>
                        </tr>
                        <tr>
                            <td colspan="5"><input type="button" value="提交" onclick="saveDeviceRepairConfirm()"></td>
                        </tr>
                    </table>
                </div>
            </div>
...
<script type="text/javascript">
    function saveDeviceRepairConfirm() {
        ...
        var url = "${pageContext.request.contextPath}/deviceRepair/saveDeviceRepairConfirm";
        $.ajax({
            url:url,
            type:"POST",
            data:{
