...
<div id="TabbedPanels1" class="TabbedPanels">
	<div class="TabbedPanelsContentGroup">
		<div class="TabbedPanelsContent">
			<input id="auditStage" value="4" type="hidden"/>
			...
			<div id="TabbedPanels1" class="TabbedPanels">
				<div class="site-box">
					<div class="site-content">
						<div>
							<div id="toolbar">
								<form class="form-inline" name="exportForm">
									...
									<sec:authorize ifAnyGranted="ROLE_SUPERADMIN,ROLE_ASSETMANAGER,ROLE_ASSETMANAGEMENT">
										<div class="form-group">
											<div class="input-group">
												<div class="input-group-addon">报修时间段</div>
												<input class="Wdate" id="starttime" name="starttime" type="text"
													   value="<fmt:formatDate value="${starttime}" pattern="yyyy-MM-dd"/>"
													   onclick="WdatePicker({dateFmt:'yyyy-MM-dd',onpicked:function(){refreshBootstrapTable();},oncleared:function(){refreshBootstrapTable();}})" />
												<span style="margin:0 2px;">到</span>
												<input class="Wdate" id="endtime" name="endtime" type="text"
													   value="<fmt:formatDate value="${starttime}" pattern="yyyy-MM-dd"/>"
													   onclick="WdatePicker({dateFmt:'yyyy-MM-dd',onpicked:function(){refreshBootstrapTable();},oncleared:function(){refreshBootstrapTable();}})" />
											</div>
										</div>
										<input class="btn-new" type="submit" onclick="exportDeviceRepairCount();" value="设备维修统计导出">
									</sec:authorize>
								</form>
							</div>
