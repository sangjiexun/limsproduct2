...
<c:if test="${state == 5 && isAudit == 1}">
   <table>
        <tr>
           ...
           <input type="radio" name="auditResult5"  value="0" />拒绝
            </td>
       </tr>
        <tr>
...
function savelabRoomDepartmentDirectorAudit(){
	...
	window.location.href="${pageContext.request.contextPath}/LabRoomReservation/savelabRoomDepartmentDirectorAudit?id=${id}&tage=${tage}&state=${state }&currpage=${currpage}&auditResult="+auditResult+"&remark="+remark;
}
</script>
</body>
<!-------------列表结束----------->
