...
function savelabRoomAdminAudit(){
	...
	window.location.href="${pageContext.request.contextPath}/LabRoomReservation/savelabRoomAdminAudit?id=${id}&tage=${tage}&state=${state }&currpage=${currpage}&auditResult="+auditResult+"&remark="+remark;
}
</script>
</body>
<!-------------列表结束----------->
