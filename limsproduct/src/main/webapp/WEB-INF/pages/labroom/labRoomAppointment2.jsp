...
<head>
    ...
    <script type="text/javascript">
        // 使用人数判断-切换
        function change_num() {
            var val = $("#num_range").val();
            if(val != "" && val==0) {
                document.getElementsByClassName("number").item(0).style.display="block";
                document.getElementsByClassName("num_range").item(0).style.display="none";
            }
        }
    </script>
    <script type="text/javascript"
    ...
    <ul class="TabbedPanelsTabGroup" style="margin-bottom:10px;">
        <li class="TabbedPanelsTab selected" id="s1">
            <a href="${pageContext.request.contextPath}/LabRoomReservation/labRoomList?currpage=1"><spring:message
                    code="all.trainingRoom.labroom"/>预约</a></li>
                ...
                <div class="TabbedPanelsContent">
                    <form id="formid" method="POST" autocomplete="off">
                        <table class="tab_lab">
                                ...
                                <td>
                                    <select class="chzn-select" id="labRoom" onchange="selectLabRoom();onChangeDate();">
                                        ...
                                        <c:forEach items="${labRooms}" var="lab">
                                            ...
                                            <option id="labRoomCapacity" value="${lab.labRoomCapacity}" type="hidden" ></option>
                                        </c:forEach>
                                    </select>
                                </td>
                                <th><spring:message code="all.trainingRoom.labroom"/>容量</th>
                                <td>
                                    <input id="capacity" type="text" value="" readonly />
                                </td>
                                <th>选择日期</th>
                                <td>
                                    <input class="Wdate" id="lendingTime" name="lendingTime" type="text" placeholder="请选择日期"
                                           value="<fmt:formatDate value="${labReservation.lendingTime.time}" pattern="yyyy-MM-dd"/>"
                                           onclick="WdatePicker({minDate:'%y-%M-{%d}',dateFmt:'yyyy-MM-dd',onpicked:function(){onChangeDate();}})" style="width: 90px !important;" />
                            ...
                            <tr>
                                <input type="hidden" value="${currAcademy.academyName}" id="lendingUnit" name="lendingUnit" />
                                <th>预约用途</th>
                                <td>
                                ...
                                <td>
                                    <select id="num_range" name="number" class="num_range" onchange="change_num()">
                                    ...
                                    <input style="display: none" id="number" name="number" class="number" required="true" value="${labReservation.number }"
                                          placeholder="请输入数值" onkeyup="value=value.replace(/[^\d]/g,'')" type="text"/>
                                </td>
                                <th>预约人电话<span style="color:red;">*</span></th>
                                <td>
                                    <input id="lendingUserPhone" name="lendingUserPhone" required="true"
                                           value="${user.telephone }" type="text"/>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <script type="text/javascript">
                        ...
                        function saveLabRoomLending() {
                            ...
                            if (((!$("#num_range").val()) || $("#num_range").val() == 0) && !$("#number").val()) {
                                alert("请输入使用人数");
                                return false;
                            }
