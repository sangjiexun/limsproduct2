...
<!-- 权限，专职管理员和超级管理员可以审核  -->
	<sec:authorize ifAnyGranted="ROLE_SUPERADMIN,ROLE_FULLTIMEMANAGER"> 									
			...
			<ul class="TabbedPanelsTabGroup">				
				...
				<li class="TabbedPanelsTab" id="s7"><a herf="javacaript:void(0)" onclick="switchover(6)">7化学品安全</a></li>
				<li class="TabbedPanelsTab" id="s8"><a herf="javacaript:void(0)" onclick="switchover(7)">8仪器设备安全</a></li>
				<li class="TabbedPanelsTab" id="s9"><a herf="javacaript:void(0)" onclick="switchover(8)">9个人防护与其它</a></li>				
			</ul>	
