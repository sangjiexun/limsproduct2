...
function exportAlls(){
  window.location.href="${pageContext.request.contextPath}/teaching/coursesite/experimentalmanagement?currpage=1";
}
...
<body>
	<div class="navigation">
		<div id="navigation">
			<ul>
				...
				<li class="end"><a href="javascript:void(0)">课程大纲管理</a></li>
			</ul>
		</div>
	</div>
	...
	<div class="right-content">
		<div id="TabbedPanels1" class="TabbedPanels">
				...
				<div class="TabbedPanelsContent">
					<div class="content-box">
						<div class="title">
							...
							<input class="btn btn-new" type="button" value="${pageContext.request.contextPath}/teaching/coursesite/outline/exportOutline?page=${currpage}"/>
						...
						<div class="tool-box">
							<form:form name="form"
								action="${pageContext.request.contextPath}/teaching/coursesite/experimentalmanagement?currpage=1"
        						...
        						<li style="overflow:hidden;">
        						       <input style="margin: 0 0 0 25px;" type="button"
										onclick="exportAll('${pageContext.request.contextPath}/teaching/coursesite/experimentalmanagement?currpage=1');"
										value="搜索">
										</li>
										<li>
										<input type="button"
		   ...
		   <option value="${pageContext.request.contextPath}/teaching/coursesite/experimentalmanagement?currpage=${currpage}">${currpage}</option>
		   <c:forEach begin="${pageModel.firstPage}" end="${pageModel.lastPage}" step="1" varStatus="j" var="current">	
           <c:if test="${j.index!=currpage}">
           <option value="${pageContext.request.contextPath}/teaching/coursesite/experimentalmanagement?currpage=${j.index}">${j.index}</option>
           </c:if>
           </c:forEach>
           </select> 页
