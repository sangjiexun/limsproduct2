...
function submitForm()
{
  ...
  $("input[name='items']:checked").each(function(){
	...
	if(flag)
	{
	  ...
	  document.itemsForm.action="${pageContext.request.contextPath}/operation/importOperationOutline?termId="+$("#term").val()+"&itemIds="+ids;
...
function first(){
	document.form.action="listOperationExperimentalItemImport?currpage=1";
...
function previous(){
    ...
    document.form.action="listOperationExperimentalItemImport?currpage="+page;
    document.form.submit();
}
...
function exportAlls(){
  window.location.href="${pageContext.request.contextPath}/operation/listOperationExperimentalItemImport?currpage=1";
}
</script>
<!-- 打印插件的引用 -->
...
<body>
	...
	<div class="right-content">
		<div id="TabbedPanels1" class="TabbedPanels">
							...
							<form:form name="form"
        						...
        						<li style="overflow:hidden;">
        						       <input style="margin: 0 0 0 25px;" type="button"
										onclick="exportAll('${pageContext.request.contextPath}/operation/listOperationExperimentalItemImport?currpage=1');"
										value="搜索">
										</li>
										<li>
										<input type="button"
		   ...
		   <option value="${pageContext.request.contextPath}/operation/listOperationExperimentalItemImport?currpage=${currpage}">${currpage}</option>
