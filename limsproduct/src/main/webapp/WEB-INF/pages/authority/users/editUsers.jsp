...
<html>
<head>
<title>Edit <fmt:message key="authority.title"/> <fmt:message key="user.title"/></title>
</head>
<body>
<div id="contentarea">      
	...
	<div id="content">
		...
		<form:form action="${pageContext.request.contextPath}/saveAuthorityUsers" method="POST" modelAttribute="user">
