        ...
        <div class="TabbedPanelsContent0">
            ...
            <div class="content-box">
                <div class="tool-box" style="overflow: initial;">
                    <form:form name="form" method="Post" action="${pageContext.request.contextPath}/system/user/student?currpage=1" modelAttribute="user">
                        <ul>
                            <li> 用户:
                                <form:input path="username"></form:input>
                            </li>
                            <li><input type="submit" value="查询">
                                <a href="${pageContext.request.contextPath}/system/user/student?currpage=1"><input class="cancel-submit" type="button" value="取消查询"></a>
...
<%--                                         <a class="btn btn-normal" href="${pageContext.request.contextPath}/system/userDetailInfo?num=${current.username}&">信息展示</a>--%>
                                    <a href="${pageContext.request.contextPath}/system/deleteStudent?username=${current.username}"
