        ...
        <div class="TabbedPanelsContentGroup">
            <div class="TabbedPanelsContent">
                <div class="content-box">
                    <form:form id="queryForm" action="${pageContext.request.contextPath}/performance/savePerformance?type=2"  method="post" modelAttribute="individualPerformance" >
                        <form:hidden path="id"/>
                        <table class="tab_lab">
                            <tr>
                                <th>新开课课程名称</th>
                        ...
                        <div class="popup_btns">
                            ...
                            <input class="btn popup_close" type="button" onclick="cancel()" value="取消"/>
                        </div>
                    </form:form>
                </div>
            </div>
