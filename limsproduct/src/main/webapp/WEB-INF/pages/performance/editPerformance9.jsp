        ...
        function upload(type){
            ...
            $('#file_upload').uploadify({
                ...
                onQueueComplete : function(data) {//当队列中的所有文件全部完成上传时触发
                    ...
                    window.location.href="${pageContext.request.contextPath}/performance/editPerformance?type=9&id="+${individualPerformance.id};
                }
            });
        ...
        <div class="TabbedPanelsContentGroup">
            <div class="TabbedPanelsContent">
                <div class="content-box">
                    <form:form id="queryForm" action="${pageContext.request.contextPath}/performance/savePerformance?type=9"  method="post" modelAttribute="individualPerformance" >
                        <form:hidden path="id"/>
                        <table class="tab_lab">
                            <tr>
                                <th>颁奖部门或单位</th>
