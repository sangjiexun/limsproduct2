        ...
        <div class="TabbedPanelsContentGroup">
            <div class="TabbedPanelsContent">
                <div class="content-box">
                    <form:form id="queryForm" action="${pageContext.request.contextPath}/performance/savePerformance?type=14"  method="post" modelAttribute="individualPerformance" >
                        <form:hidden path="id"/>
                        <table class="tab_lab">
                            <tr>
                                <th>项目名称</th>
                        ...
                        <div class="popup_btns">
                            ...
                            <input type="button" onclick="cancel()"  class="btn btn-return" value="取消"/>
                        </div>
                    </form:form>
                </div>
            </div>
