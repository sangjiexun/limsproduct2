        ...
        <div class="TabbedPanelsContentGroup">
            <div class="TabbedPanelsContent">
                <div class="content-box">
                    <form:form  id="queryForm" action="${pageContext.request.contextPath}/performance/savePerformance?type=5"  method="post" modelAttribute="individualPerformance" >
                        <form:hidden path="id"/>
                        <table class="tab_lab">
                            <tr>
                                <th>活动项目名称</th>
                        ...
                        <div class="popup_btns">
                            <input type="button" onclick="save()" class="btn btn-big" value="确定"/>
                            <input type="button" onclick="cancel()"  class="btn popup_close btn-return" value="取消"/>
                        </div>
                    </form:form>
                </div>
            </div>
