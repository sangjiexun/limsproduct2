...
function cancel()
{
  window.location.href="${pageContext.request.contextPath}/report/reportOperationItemRequire?currpage=1";
}
...
function getLabRoom(){
  ...
  <div class="navigation">
    <div id="navigation">
	  <ul>
		  ...
		  <li class="end"><a href="javascript:void(0)"><spring:message code="left.report.labrequire" /></a></li>
	  </ul>
	</div>
  </div>
  ...
  <div id="TabbedPanels1" class="TabbedPanels">
	  <ul class="TabbedPanelsTabGroup">
		  <li class="TabbedPanelsTab1 selected" id="s1">
			  <a href="javascript:void(0)">实验要求统计表</a>
		  </li>
		  <a href="#" onclick="targetUrl('${pageContext.request.contextPath}/report/exportOperationItemRequire')"><input class="btn btn-new" type="button" value="导出"></a>
  ...
  <div class="content-box">
	...
	<tbody>
	<form name="queryForm" method="Post" action="${pageContext.request.contextPath}/report/reportOperationItemRequire?currpage=1">
		<ul>
			<li>学期:
			...
			<li>实验室:
			  <select class="chzn-select" path="labRoom.id" name="roomId" id="labRoom" style="width:206px" multiple="multiple" data-placeholder="未选择实验室">
...
<form name="form" method="Post" action="${pageContext.request.contextPath}/report/reportOperationItemRequire?currpage=1">	
	<table class="tb" id="my_show">
	  <thead style="center-content">
		  ...
		  <tr>
        	...
        	<th style="border:solid 1px #4F4F4F !important;" width= "3% " colspan="4">必修实验</th>
        	<th style="border:solid 1px #4F4F4F !important;" width= "3% " colspan="4">选修实验</th>
        	<th style="border:solid 1px #4F4F4F !important;" width= "3% " colspan="4">其他实验</th>
		  </tr>
		  <tr>
	  ...
	  <c:if test="${items.size() eq 1 }"> <!-- 当选择的是某一个具体中心时进行这些操作 -->
		  <c:if test="${i.count eq 1}">
		  	<tr>
		  		<td>1</td>
		  		<td>${curr.centerNumber}</td>
