...
<!-- 打印插件的引用 -->
  ...
  <script type="text/javascript">
	  function cancel(){
		  window.location.href="${pageContext.request.contextPath}/report/reportLabOpenRateInfo"
	  }
  </script>
	...
	<div class="navigation">
		<div id="navigation">
			<ul>
				...
				<li class="end"><a href="javascript:void(0)"><spring:message code="left.report.labratesdu" /></a></li>
			</ul>
		</div>
	</div>
	<!--导航结束  -->
		...
		<div id="TabbedPanels1" class="TabbedPanels">
			<ul class="TabbedPanelsTabGroup">
				<li class="TabbedPanelsTab1 selected" id="s1">
					<a href="javascript:void(0)">实验室使用率汇总表</a>
				</li>
			</ul>
			<div class="TabbedPanelsContentGroup1">
				<div class="TabbedPanelsContent">
					<%--<div class="tool-box">--%>
						<%--<form id="subform" name='f' action='${pageContext.request.contextPath}/report/reportLabOpenRateInfo' method='POST'>--%>
						<%--<ul>--%>
					...
					<div class="content-box">
						<table>
							...
							<tr height="20px">
								...
								<th height="20px" align="center">额定学时数</th>
								<th height="20px" align="center">教学时数</th>
								<th height="20px" align="center">开放时数</th>
								<th height="20px" align="center">教学利用率</th>
								<th height="20px" align="center">开放利用率</th>
								<th height="20px" align="center">综合利用率</th>
							</tr>
							</thead>
							<tbody>
							...
							<c:forEach items="${list}" var="curr" varStatus="i">
								<c:if test="${year!=curr[7]&&i.count!=1 }">
									<c:if test="${curr[8]==3}">
										<tr>
											...
											<td>5654</td>
											<td>${a4}</td>
											<td>${5654*100/14336}%</td>
											<td>${a4*100/14336}%</td>
											<td>${(a4+5654)*100/14336}%</td>
										</tr>
									</c:if>
									<c:if test="${curr[8]!=3}">
										<tr>
								...
								<c:if test="${curr[8]==3}">
									<tr>
										...
										<td>5654</td>
										<td>${curr[4]}</td>
										<td><fmt:formatNumber type="number" value="${5654*100/14336}" pattern="0.00" maxFractionDigits="2"/>%</td>
										<td>
											<fmt:formatNumber type="number" value="${curr[4]*100/14336}" pattern="0.00" maxFractionDigits="2"/>%
										</td>
										<td>
											<fmt:formatNumber type="number" value="${(curr[4]+5654)*100/14336}" pattern="0.00" maxFractionDigits="2"/>  %
										</td>
									</tr>
								</c:if>
								<c:if test="${curr[8]!=3}">
