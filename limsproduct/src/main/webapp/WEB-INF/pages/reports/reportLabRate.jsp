...
<ul class="TabbedPanelsTabGroup">
	...
	<input class="btn btn-new" type="button" onclick="javascript:window.print();" value="打印"/>
	<input class="btn btn-new" type="button" onclick="searchForExport();" value="导出"/>
</ul>
<%--<div class="title">--%>
...
<ul>
	...
	<li><input type="submit" value="查询"/>
		...
		<input type="button" onclick="searchForExport();" value="导出"/>
	</li>
</ul>
</form:form>
</div>
...
<div id="container" style="min-width: 310px; height: 400px; margin: 10px auto" class="Noprint"></div>
<br />
