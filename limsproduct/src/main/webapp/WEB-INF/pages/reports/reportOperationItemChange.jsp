...
function cancel()
{
  window.location.href="${pageContext.request.contextPath}/report/reportOperationItemChange?currpage=1";
}
...
function getLabRoom(){
  ...
  <div class="navigation">
    <div id="navigation">
	  <ul>
		  ...
		  <li class="end"><a href="javascript:void(0)"><spring:message code="left.report.labchange" /></a></li>
	  </ul>
	</div>
  </div>
  ...
  <div id="TabbedPanels1" class="TabbedPanels">
	  <ul class="TabbedPanelsTabGroup">
		  <li class="TabbedPanelsTab1 selected" id="s1">
			  <a href="javascript:void(0)">实验变动统计表</a>
		  </li>
		  <a href="#" onclick="targetUrl('${pageContext.request.contextPath}/report/exportOperationItemChange')"><input class="btn btn-new" type="button" value="导出"></a>
  ...
  <div class="content-box">
	...
	<tbody>
	<form name="queryForm" method="Post" action="${pageContext.request.contextPath}/report/reportOperationItemChange?currpage=1">
		<ul>
			<li>学期:
			...
			<li>实验室:
			  <select class="chzn-select" path="operationItem.labRoom.id" name="roomId" id="labRoom" style="width:206px" multiple="multiple" data-placeholder="未选择实验室">
	...
	<table class="tb" id="my_show">
	  <thead style="center-content">
		  ...
		  <tr>
        	...
        	<th style="border:solid 1px #4F4F4F !important;" width= "3% " colspan="2">总实验</th>
        	<th style="border:solid 1px #4F4F4F !important;" width= "3% " colspan="4">新开</th>
        	<th style="border:solid 1px #4F4F4F !important;" width= "3% " colspan="4">改进</th>
        	<th style="border:solid 1px #4F4F4F !important;" width= "3% " colspan="4">未变动</th>
        	<th style="border:solid 1px #4F4F4F !important;" width= "3% " colspan="4">未开</th>
        	<th style="border:solid 1px #4F4F4F !important;" width= "3% " colspan="4">撤消</th>
		  </tr>
		  <tr>
	  ...
	  <c:if test="${item.size() ne 1 }"> <!-- 当选择的是某一个具体中心时没有必要进行这些操作 -->
		  <!-- 计算整个学院的五种变动类型的总个数和总时数 -->
	  ...
	  <c:if test="${items.size() ne 1 }"> <!-- 当选择的是某一个具体中心时进行这些操作 -->
		  <c:if test="${i.count eq 1}">
		  	<tr>
		  		<td>1</td>
		  		<td>${curr.centerNumber}</td>
	  	...
	  	<tr>
	  		...
	  		<td>${curr.count1+curr.count2+curr.count3+curr.count4+curr.count5}</td>
	  		<td>${curr.hour1+curr.hour2+curr.hour3+curr.hour4+curr.hour5}</td>
	  		<td>${curr.count1 }</td>
	  		<td>${curr.hour1 }</td>
	  		<td><fmt:formatNumber type="number" value="${curr.count1/curr.countTotal*100}" maxFractionDigits="2"/></td>
	  		<td><fmt:formatNumber type="number" value="${curr.hour1/curr.hourTotal*100}" maxFractionDigits="2"/></td>
