        ...
        <div class="TabbedPanelsContentGroup">
            <div class="TabbedPanelsContent">
                <div class="content-box">
                    <%--导师未审核时显示--%>
                    <c:if test="${state le 1 && isAudit == 0 && state gt 0}">
                    ...
                    <c:if test="${state == 1 && isAudit == 1}">
                        <table>
                            ...
                            <tr>
                                <td colspan="5"><input type="button" value="提交" onclick="saveTeacherAudit()"> </td>
                            </tr>
                        </table>
                    </c:if>
                    <%--导师审核后显示--%>
                    <c:if test="${state gt 1  || state le 1}">
                        <table id="listTable" width="50%" cellpadding="0" cellspacing="0" class="tablesorter" >
                            <tr><td colspan="6">审核信息 </td>
                            </tr>
                            <tr align="center" >
                                <td>审核人：</td>
                                <td>${user.cname }</td>
...
<script type="text/javascript">
    function saveTeacherAudit(){
        ...
        window.location.href="${pageContext.request.contextPath}/labRoomLending/saveTeacherAuditforlabRoomlend?id=${id}&tage=${tage}&state=${state }&page=${page}&auditResult="+auditResult+"&remark="+remark;
    }
</script>
</body>
<!-------------列表结束----------->
