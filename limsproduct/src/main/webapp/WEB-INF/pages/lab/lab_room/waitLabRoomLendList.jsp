...
<div id="TabbedPanels1" class="TabbedPanels">
	<ul class="TabbedPanelsTabGroup">
		...
		<a href="${pageContext.request.contextPath}/labRoom/waitlabRoomLendList?page=1">未审核</a>
		</li>
		<%-- <li class="TabbedPanelsTab" tabindex="0">
            ...
            <table class="tb" id="my_show"> 
                ...
                <tbody>
                        ...
                        <tr>
                        	...
                        	<c:if test="${ca eq true }">
                        	<td>
	                        	<a href="${pageContext.request.contextPath}/labRoom/auditLabRoomLending?idKey=${current.id}">审核</a>  
                        	</td> 
                        	</c:if>	
                        </tr>
                		</c:forEach>
