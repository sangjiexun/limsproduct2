...
<body>
  ...
  <div class="content-box">
	...
	<form:form name="form" action="${pageContext.request.contextPath }/choseDissertation/saveDissertation?professorId=${professorId }" method="post" modelAttribute="choseDissertation" >
