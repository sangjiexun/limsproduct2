...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/My97DatePicker/WdatePicker.js"></script>
  ...
  <div class="content-box">
	...
	<form:form name="form" action="${pageContext.request.contextPath }/choseDissertation/saveChoseThemecreateBatch" method="post" modelAttribute="choseTheme" >
	 <div class="new-classroom">
	  <form:hidden path="id"/>
	  <fieldset>
	    <label>选题开始时间: </label>
	   	<input class="easyui-datebox" id="start" name="start" required="true" type="text"  onclick="new Calendar().show(this);" style="width:100px;" />
	   </fieldset>
	   <fieldset>
	     <label>选题结束时间: </label>
	   	 <input id="end" name="end" type="text" required="true"  class="easyui-datebox"    onclick="new Calendar().show(this);" style="width:100px;" />
	   </fieldset>
	   <fieldset>
	     <label>批次数量：</label>
	  	 <form:input path="batchNumber"  type="text" id="batchNumber" class="easyui-validatebox"  onchange="addBatch()"  onkeyup="this.value=this.value.replace(/[^1-5-]+/,'');"/>
	  </fieldset>
	  <div id="addBatch"></div>
	 </div> 
