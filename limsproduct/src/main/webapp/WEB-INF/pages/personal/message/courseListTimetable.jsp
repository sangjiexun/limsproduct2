...
<head>
    ...
    <script type="text/javascript">
        function cancel() {
            window.location.href="${pageContext.request.contextPath}/CourseListTimetable"
        }
    </script>
</head>
        ...
        <div class="TabbedPanelsContentGroup">
            <div class="TabbedPanelsContent">
                <div class="content-box">
                    <%--<div class="title">--%>
                        <%--<div id="title">我的课程</div>--%>
                    <%--</div>--%>

                    <div class="tool-box">
                        <form:form name="queryForm" action="${pageContext.request.contextPath}/CourseListTimetable" method="post"  >
                            <ul>
                                <li>课程名称</li>
                                <li><input id="courseName" name="courseName" type="text"/></li>
                                <li>周次</li>
                                <li><select name="weeks" class="chzn-select">
                                ...
                                <li>开始日期</li>
                                <li><input name="class_date" class="easyui-datebox" value="<fmt:formatDate value='${current[12]}' pattern='yyyy/MM/dd'/>" /></li>
                                <li>
                    ...
                    <table class="tb" id="my_show">
                       ...
                       <tr>
                           ...
                           <td>${current[6]}</td>
                           <td>${current[19]}</td>
                           <td><fmt:formatDate value="${current[12]}" pattern="yyyy/MM/dd"/></td>
                           <td>${current[8]}</td>
