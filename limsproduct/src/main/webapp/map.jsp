...
<head>
    ...
    <link href="${pageContext.request.contextPath}/css/visualization/floor/layout_header.css" rel="stylesheet"
          type="text/css">
...
<body>
<!--百度地图容器-->
<div style="width:1862px;height:780px;border:#ccc solid 1px;" id="dituContent"></div>
</body>
<script type="text/javascript">
    //创建和初始化地图函数：
    function initMap(){
    ...
    //标注点数组
    var markerArr = [{title:"松江校区",content:"点击右上角进入可视化引擎",point:"121.222309|31.06217",isOpen:0,icon:{w:23,h:25,l:46,t:21,x:9,lb:12}}
        ,{title:"延安路校区",content:"点击右上角进入可视化引擎",point:"121.420609|31.212456",isOpen:0,icon:{w:23,h:25,l:46,t:21,x:9,lb:12}}
    ];
    //创建marker
    function addMarker(){
