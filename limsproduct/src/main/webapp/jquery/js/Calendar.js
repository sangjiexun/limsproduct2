...
// <input type="button" name="button" id="button" value="button" onclick="new
// Calendar().show(this.form.control_date);" /></span>
// <span>至
// <input name="control_date2" type="text" id="control_date2" size="10"
// maxlength="10" onclick="new Calendar().show(this);" readonly="readonly" />
// <input type="button" name="button" id="button1" value="button" onclick="new
// Calendar().show(this.form.control_date2);" /></span>
