...
(function($) {
	function _1(_2) {
		...
		var _4 = $("<input type=\"text\" class=\"searchbox-text\">")
				.appendTo(_3);
	...
	function _6(_7) {
		...
		var _9 = _8.width - sb.find("a.searchbox-menu").outerWidth()
	...
	function _a(_b) {
		...
		function _f(_11) {
			...
			_c.searchbox.find("input.searchbox-text").attr("name",
					$(_11.target).attr("name") || _11.text);
			_6(_b);
		};
	};
	function _12(_13) {
		...
		_16.unbind(".searchbox").bind("blur.searchbox", function(e) {
					...
					if (e.keyCode == 13) {
						e.preventDefault();
						var _18 = $.fn.prop ? _16.prop("name") : _16
								.attr("name");
						_15.value = $(this).val();
	...
	$.fn.searchbox.methods = {
		...
		selectName : function(jq, _23) {
			return jq.each(function() {
						...
						if (_24) {
							_24.children("div.menu-item[name=\"" + _23 + "\"]")
