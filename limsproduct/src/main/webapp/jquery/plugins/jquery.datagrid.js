...
(function($) {
	...
	function _b(_c) {
		...
		if (_d.height != "auto") {
			var _19 = _10
					- _13.children("div.datagrid-header").outerHeight(true)
					- _13.children("div.datagrid-footer").outerHeight(true)
					- _e.children("div.datagrid-toolbar").outerHeight(true)
					- _e.children("div.datagrid-pager").outerHeight(true);
	...
	function _2c(_2d, _2e) {
		...
		var _33 = $("<div class=\"datagrid-wrap\">"
				...
				+ "</div>" + "</div>").insertAfter(_2d);
		_33.panel({
					doSize : false
				});
		_33.panel("panel").addClass("datagrid").bind("_resize",
				function(e, _34) {
		...
		return {
			...
			dc : {
				...
				view1 : _3a,
				view2 : _3b,
				body1 : _3a.children("div.datagrid-body")
						.children("div.datagrid-body-inner"),
				body2 : _3b.children("div.datagrid-body"),
				footer1 : _3a.children("div.datagrid-footer")
						.children("div.datagrid-footer-inner"),
				footer2 : _3b.children("div.datagrid-footer")
						.children("div.datagrid-footer-inner")
			}
		};
	};
	...
	function _56(_57) {
		...
		tr.find("div.datagrid-cell-check input[type=checkbox]")
				.unbind(".datagrid").bind("click.datagrid", function(e) {
					var _65 = $(this).parent().parent().parent()
	...
	function _69(_6a) {
		...
		_6d.find("td:has(div.datagrid-cell)").unbind(".datagrid").bind(
		...
		_6d.find("input[type=checkbox]").unbind(".datagrid").bind(
		...
		function _6f(_70, _71) {
			...
			_70.bind("click.datagrid", function(e) {
						...
						if (_6c.onSortColumn) {
							_6c.onSortColumn.call(_6a, _6c.sortName,
									_6c.sortOrder);
						}
					});
		};
	...
	function _76(_77) {
		...
		function _82(col, _83) {
			col.width += _83;
			col.boxWidth += _83;
			_79.find("td[field=\"" + col.field + "\"] div.datagrid-cell")
					.width(col.boxWidth);
		};
	};
	function _36(_84, _85) {
		...
		if (_85) {
			...
			var _88 = dc.view1.children("div.datagrid-header").add(dc.view2
		...
		function fix(_89) {
			var col = _7d(_84, _89);
			var bf = _87.finder.getTr(_84, "", "allbody").add(_87.finder.getTr(
					_84, "", "allfooter"));
	...
	function _8b(_8c) {
		...
		var _8e = dc.view1.children("div.datagrid-header").add(dc.view2
				.children("div.datagrid-header"));
		...
		if (!_a6.remoteSort) {
			...
			if (opt) {
				...
				_a5.rows.sort(function(r1, r2) {
							return _aa(r1[_a6.sortName], r2[_a6.sortName])
									* (_a6.sortOrder == "asc" ? 1 : -1);
						});
			}
		}
	...
	function _ba(_bb) {
		...
		var tr = _bc.finder.getTr(_bb, "", "allbody")
	...
	function _b8(_c1) {
		...
		var tr = _c2.finder.getTr(_c1, "", "selected")
	...
	function _67(_c7, _c8) {
		...
		if (top <= 0) {
			...
			if (top + tr.outerHeight() > _cd.height() - 18) {
				_cd.scrollTop(_cd.scrollTop() + top + tr.outerHeight()
						- _cd.height() + 18);
			}
		}
	};
		...
		tr.children("td").each(function() {
			...
			if (col && col.editor) {
				...
				if (_fd) {
					...
					_f9.children("table").bind("click dblclick contextmenu",
							function(e) {
								e.stopPropagation();
							});
					$.data(_f9[0], "datagrid.editor", {
								actions : _fd,
								target : _fd.init(_f9.find("td"), _fc),
								field : _fa,
								type : _fb,
								oldHtml : _fe
							});
	...
	var _132 = {
		text : {
			init : function(_133, _134) {
				var _135 = $("<input type=\"text\" class=\"datagrid-editable-input\">")
						.appendTo(_133);
				return _135;
			},
		...
		textarea : {
			init : function(_13c, _13d) {
				var _13e = $("<textarea class=\"datagrid-editable-input\"></textarea>")
						.appendTo(_13c);
				return _13e;
			},
		...
		checkbox : {
			...
			setValue : function(_149, _14a) {
				...
				$.fn.prop ? $(_149).prop("checked", _14b) : $(_149).attr(
						"checked", _14b);
			}
		},
		numberbox : {
			init : function(_14c, _14d) {
				var _14e = $("<input type=\"text\" class=\"datagrid-editable-input\">")
						.appendTo(_14c);
				_14e.numberbox(_14d);
				return _14e;
			},
		...
		validatebox : {
			init : function(_156, _157) {
				var _158 = $("<input type=\"text\" class=\"datagrid-editable-input\">")
						.appendTo(_156);
	...
	$.fn.datagrid.methods = {
		options : function(jq) {
			...
			var opts = $.extend(_17b, {
						width : _17c.width,
						height : _17c.height,
						closed : _17c.closed,
						collapsed : _17c.collapsed,
						minimized : _17c.minimized,
						maximized : _17c.maximized
					});
			var _17d = jq.datagrid("getPager");
			if (_17d.length) {
				var _17e = _17d.pagination("options");
				$.extend(opts, {
							pageNumber : _17e.pageNumber,
							pageSize : _17e.pageSize
						});
			}
			return opts;
		},
		...
		reloadFooter : function(jq, _185) {
			return jq.each(function() {
						...
						if (opts.showFooter) {
							opts.view.renderFooter.call(opts.view, this, _187
											.find("div.datagrid-footer-inner"),
									false);
							opts.view.renderFooter.call(opts.view, this, _186
											.find("div.datagrid-footer-inner"),
									true);
			...
			return jq.each(function() {
				...
				if (opts.loadMsg) {
					...
					$("<div class=\"datagrid-mask-msg\" style=\"display:block\"></div>")
							.html(opts.loadMsg).appendTo(_188);
					_1a(this);
				}
			});
		},
	...
	$.fn.datagrid.parseOptions = function(_19d) {
		var t = $(_19d);
		return $.extend({}, $.fn.panel.parseOptions(_19d), {
	...
	var _19e = {
		render : function(_19f, _1a0, _1a1) {
			...
			for (var i = 0; i < rows.length; i++) {
				var cls = (i % 2 && opts.striped)
						...
						: "";
				var _1a4 = opts.rowStyler ? opts.rowStyler.call(_19f, i,
						rows[i]) : "";
				var _1a5 = _1a4 ? "style=\"" + _1a4 + "\"" : "";
				_1a3.push("<tr datagrid-row-index=\"" + i + "\" " + cls + " "
						+ _1a5 + ">");
				_1a3.push(this.renderRow.call(this, _19f, _1a2, _1a1, i,
						rows[i]));
				_1a3.push("</tr>");
			}
		...
		renderRow : function(_1ab, _1ac, _1ad, _1ae, _1af) {
			...
			for (var i = 0; i < _1ac.length; i++) {
				...
				if (col) {
					var _1b2 = col.styler
							? (col.styler(_1af[_1b1], _1af, _1ae) || "")
							: "";
					var _1b3 = col.hidden ? "style=\"display:none;" + _1b2
							+ "\"" : (_1b2 ? "style=\"" + _1b2 + "\"" : "");
		...
		refreshRow : function(_1b4, _1b5) {
			var row = {};
			var _1b6 = $(_1b4).datagrid("getColumnFields", true).concat($(_1b4)
		...
		updateRow : function(_1b7, _1b8, row) {
			...
			for (var _1b9 in row) {
				...
				if (col) {
					var _1ba = col.styler ? col.styler(rows[_1b8][_1b9],
							rows[_1b8], _1b8) : "";
					td.attr("style", _1ba || "");
					if (col.hidden) {
						td.hide();
					...
					if (col.formatter) {
						cell.html(col.formatter(rows[_1b8][_1b9], rows[_1b8],
								_1b8));
					} else {
			...
			var _1ba = opts.rowStyler ? opts.rowStyler.call(_1b7, _1b8,
					rows[_1b8]) : "";
			tr.attr("style", _1ba || "");
		...
		insertRow : function(_1bb, _1bc, row) {
			...
			for (var i = data.rows.length - 1; i >= _1bc; i--) {
				opts.finder.getTr(_1bb, i, "body", 2).attr(
						"datagrid-row-index", i + 1);
				var tr = opts.finder.getTr(_1bb, i, "body", 1).attr(
						"datagrid-row-index", i + 1);
				if (opts.rownumbers) {
			...
			var tr1 = "<tr datagrid-row-index=\"" + _1bc + "\">"
					+ this.renderRow.call(this, _1bb, _1bd, true, _1bc, row)
					+ "</tr>";
			var tr2 = "<tr datagrid-row-index=\"" + _1bc + "\">"
					+ this.renderRow.call(this, _1bb, _1be, false, _1bc, row)
					+ "</tr>";
			if (_1bc >= data.rows.length) {
				if (data.rows.length) {
		...
		deleteRow : function(_1bf, _1c0) {
			...
			for (var i = _1c0 + 1; i < data.rows.length; i++) {
				opts.finder.getTr(_1bf, i, "body", 2).attr(
						"datagrid-row-index", i - 1);
				var tr1 = opts.finder.getTr(_1bf, i, "body", 1).attr(
						"datagrid-row-index", i - 1);
				if (opts.rownumbers) {
		...
		onAfterRender : function(_1c2) {
			...
			if (opts.showFooter) {
				var _1c3 = $(_1c2).datagrid("getPanel")
	...
	$.fn.datagrid.defaults = $.extend({}, $.fn.panel.defaults, {
		...
		editors : _132,
		finder : {
			getTr : function(_1c6, _1c7, type, _1c8) {
				type = type || "body";
				_1c8 = _1c8 || 0;
				...
				if (_1c8 == 0) {
					...
					if (type == "body") {
						return (_1c8 == 1 ? dc.body1 : dc.body2)
								.find(">table>tbody>tr[datagrid-row-index="
										+ _1c7 + "]");
					} else {
						if (type == "footer") {
							return (_1c8 == 1 ? dc.footer1 : dc.footer2)
									.find(">table>tbody>tr[datagrid-row-index="
											+ _1c7 + "]");
						} else {
							if (type == "selected") {
