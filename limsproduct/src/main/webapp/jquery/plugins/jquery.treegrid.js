...
(function($) {
	...
	function _16(_17, _18) {
		...
		if (_19.rownumbers
				|| (_19.frozenColumns && _19.frozenColumns.length > 0)) {
			if (_18) {
				_1e(_18);
				_1d.find("tr[node-id=" + _18 + "]").next("tr.treegrid-tr-tree")
	...
	function _2a(_2b) {
		...
		_2e.find("span.tree-hit").unbind(".treegrid").bind("click.treegrid",
				function() {
		...
		_2e.find("tr[node-id]").unbind(".treegrid").bind("mouseenter.treegrid",
				function() {
					var id = $(this).attr("node-id");
					_2e.find("tr[node-id=" + id + "]")
		...
		_2e.find("div.datagrid-cell-check input[type=checkbox]")
		...
		_2f.find("input[type=checkbox]").unbind().bind("click.treegrid",
				function() {
					if (_2c.singleSelect) {
						return false;
					}
	...
	function _32(_33, _34) {
		...
		var tr2 = _38.children("div.datagrid-body").find("tr[node-id=" + _34
				+ "]");
		var _39 = $(_33).datagrid("getColumnFields", true).length
				+ (_35.rownumbers ? 1 : 0);
		...
		function _3b(tr, _3c) {
			$("<tr class=\"treegrid-tr-tree\">"
					+ "<td style=\"border:0px\" colspan=\"" + _3c + "\">"
	...
	function _3d(_3e, _3f, _40, _41) {
		...
		var _47 = _48(_3e, _3f);
		if (_47) {
			var _49 = _45.children("div.datagrid-body").find("tr[node-id="
					+ _3f + "]");
			var _4a = _46.children("div.datagrid-body").find("tr[node-id="
					+ _3f + "]");
			var cc1 = _49.next("tr.treegrid-tr-tree").children("td")
					.children("div");
			var cc2 = _4a.next("tr.treegrid-tr-tree").children("td")
					.children("div");
		} else {
			var cc1 = _45.children("div.datagrid-body")
		...
		if (_42.showFooter) {
			_42.view.renderFooter.call(_42.view, _3e, _45
							.find("div.datagrid-footer-inner"), true);
			_42.view.renderFooter.call(_42.view, _3e, _46
	...
	function _75(_76, _77) {
		...
		var _7a = _79.find("div.datagrid-body tr[node-id=" + _77 + "]")
				.children("td[field=" + _78.treeField + "]");
	...
	function _a8(_a9, _aa) {
		...
		if (_aa.parent) {
			...
			var _ad = tr.children("td[field=" + _ab.treeField + "]")
	...
	function _af(_b0, _b1) {
		...
		if (_b4) {
			if (_b4.children.length == 0) {
				...
				var _b5 = tr.children("td[field=" + _b2.treeField + "]")
						.children("div.datagrid-cell");
				_b5.find(".tree-icon").removeClass("tree-folder")
						.addClass("tree-file");
	...
	$.fn.treegrid.methods = {
		...
		reload : function(jq, id) {
			return jq.each(function() {
						if (id) {
							...
							var _bf = $(this).datagrid("getPanel")
		...
		reloadFooter : function(jq, _c0) {
			return jq.each(function() {
						...
						var _c2 = $(this).datagrid("getPanel")
						...
						if (_c1.showFooter) {
							_c1.view.renderFooter.call(_c1.view, this, _c3
											.find("div.datagrid-footer-inner"),
									true);
							_c1.view.renderFooter.call(_c1.view, this, _c4
											.find("div.datagrid-footer-inner"),
									false);
	...
	$.fn.treegrid.parseOptions = function(_c8) {
		var t = $(_c8);
		return $.extend({}, $.fn.datagrid.parseOptions(_c8), {
	...
	var _c9 = $.extend({}, $.fn.datagrid.defaults.view, {
		render : function(_ca, _cb, _cc) {
			...
			function _d1(_d2, _d3, _d4) {
				...
				for (var i = 0; i < _d4.length; i++) {
					...
					_d5.push("<tr node-id=" + row[_cd.idField] + " " + _d7
							+ ">");
					_d5 = _d5.concat(_cf.renderRow.call(_cf, _ca, _ce, _d2,
							_d3, row));
					_d5.push("</tr>");
		...
		renderRow : function(_df, _e0, _e1, _e2, row) {
			...
			for (var i = 0; i < _e0.length; i++) {
				...
				if (col) {
					var _e5 = col.styler
							? (col.styler(row[_e4], row) || "")
							: "";
					var _e6 = col.hidden
							? "style=\"display:none;" + _e5 + "\""
							: (_e5 ? "style=\"" + _e5 + "\"" : "");
		...
		refreshRow : function(_e7, id) {
			...
			tr.children("td").each(function() {
				...
				if (col) {
					var _ee = col.styler
							? (col.styler(row[_ed], row) || "")
							: "";
					var _ef = col.hidden ? "display:none;" + _ee : (_ee
							? _ee
							: "");
					$(this).attr("style", _ef);
					var val = null;
		...
		onBeforeRender : function(_f1, _f2, _f3) {
			...
			if (_f8) {
				...
				$.data(_f1, "treegrid").data = $.data(_f1, "treegrid").data
						.concat(_f3);
			}
			if (!_f4.remoteSort) {
				this.sort(_f1, _f3);
		...
		sort : function(_f9, _fa) {
			...
			function _fd(_fe) {
				_fe.sort(function(r1, r2) {
							return _fc(r1[_fb.sortName], r2[_fb.sortName])
									* (_fb.sortOrder == "asc" ? 1 : -1);
						});
	...
	$.fn.treegrid.defaults = $.extend({}, $.fn.datagrid.defaults, {
		...
		singleSelect : true,
		view : _c9,
		loadFilter : function(data, _103) {
			return data;
		},
		finder : {
			getTr : function(_104, id, type, _105) {
				type = type || "body";
				_105 = _105 || 0;
				...
				if (_105 == 0) {
					...
					if (type == "body") {
						return (_105 == 1 ? dc.body1 : dc.body2)
								.find("tr[node-id=" + id + "]");
					} else {
						if (type == "footer") {
							return (_105 == 1 ? dc.footer1 : dc.footer2)
									.find("tr[node-id=" + id + "]");
						} else {
							if (type == "selected") {
								return (_105 == 1 ? dc.body1 : dc.body2)
