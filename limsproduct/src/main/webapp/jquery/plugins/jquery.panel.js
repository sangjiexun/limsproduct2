...
(function($) {
				...
				if (typeof _15.tools == "string") {
					$(_15.tools).children().each(function() {
						$(this).addClass($(this).attr("iconCls"))
								.addClass("panel-tool-a").appendTo(_18);
					});
				} else {
	...
	function _1a(_1b) {
		...
		if (_1c.options.href && (!_1c.isLoaded || !_1c.options.cache)) {
			...
			if (_1c.options.loadingMessage) {
				_1d.html($("<div class=\"panel-loading\"></div>")
						.html(_1c.options.loadingMessage));
			}
			$.ajax({
	...
	function _27(_31, _32) {
		...
		var _36 = _34.children("div.panel-header")
	...
	$.fn.panel = function(_55, _56) {
		...
		return this.each(function() {
					...
					if (_57) {
						...
						_58 = $.extend({}, $.fn.panel.defaults, $.fn.panel
