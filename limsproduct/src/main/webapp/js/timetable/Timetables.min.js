        ...
        _init: function (option) {
            ...
            timetable.forEach(function (values, index) {
                ...
                values.forEach(function (item, i) {
                    ...
                    if (merge && listMerge[i][index].name != "" && listMerge[i][index].length == 1) {
                    // if (merge && listMerge[i][index].length > 1) {
                        ...
                        mergeDom.innerHTML = listMerge[i][index].name;
                        mergeDom.className = "course-hasContent";
                        courseItem.appendChild(mergeDom)
                    } else if(merge && listMerge[i][index].length > 1){
                        var mergeDom = document.createElement("span");
                        mergeDom.style.position = "absolute";
                        // mergeDom.style.zIndex = 9;
                        mergeDom.style.zIndex = 1;
                ...
                if (typeof item[0] === "object") {
                    for (var v in item[0]) {
                        if(item[0][v] != ""){
                            ...
                            if(item[0]['name'] == "") {
                                handItemInner.style.height = "30px";
                                handItemInner.style.lineHeight = "50px";
                            }
