...
$(document).ready(function () {
    ...
    $('#weeks').select2({
        ...
        placeholder: '请选择周次...',
        ajax: {
            url: zuulUrl + "api/timetable/common/apiWeekListByPlan",
            contentType: "application/json",
            dataType: "json",
            beforeSend: function(request) {
                request.setRequestHeader("Authorization", getJWTAuthority());
...
function doEduReCourse(sameNumberId) {
    ...
    var index = layer.open({
        ...
        shadeClose: true,
        area: ['1100px', '500px'],
        content: contextPath + '/lims/timetable/course/updateEduAdjustCourse?currpage=1&flag=0&timetableStyle=5&courseNo=' + courseNo + "&term=" + term
