...
layui.use(['form'], function() {
    ...
    //物资名录表单初始赋值
    $.ajax({
        url: contextPath + '/lims/api/material/editAssetsApplyItem?id='+id,
        async: false,
        type: "GET",
    ...
    form.on('submit(saveAddAssetsDetail)', function(data){
        console.log('保存')
        ...
        $.ajax({
            url: contextPath + '/lims/api/material/saveAddAssetsDetail',
            data: data,
            async: false,
            type: "POST",
            contentType: "application/json;charset=UTF-8",
